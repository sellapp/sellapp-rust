...
#[serde(remote = "Self")]
pub struct SdkUpdateWalletBonusTierRequestApplicationJson {
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub minimum_top_up_cents: Option<i64>,
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub bonus_kind: Option<SdkUpdateWalletBonusTierRequestApplicationJsonBonusKind>,
    #[serde(
        skip_serializing_if = "Option::is_none",
        default,
        deserialize_with = "crate::runtime_schema::present_nullable"
    )]
    pub fixed_bonus_cents: Option<Option<i64>>,
    #[serde(
        skip_serializing_if = "Option::is_none",
        default,
        deserialize_with = "crate::runtime_schema::present_nullable"
    )]
    pub percent_basis: Option<Option<i64>>,
    #[serde(
        skip_serializing_if = "Option::is_none",
        default,
        deserialize_with = "crate::runtime_schema::present_nullable"
    )]
    pub maximum_bonus_cents: Option<Option<i64>>,
    #[serde(skip_serializing_if = "Option::is_none", default)]
...
impl Serialize for SdkUpdateWalletBonusTierRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkUpdateWalletBonusTierRequestApplicationJson {
...
impl SdkUpdateWalletBonusTierRequestApplicationJson {
