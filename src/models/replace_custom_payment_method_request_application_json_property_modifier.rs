...
#[serde(remote = "Self")]
pub struct ReplaceCustomPaymentMethodRequestApplicationJsonPropertyModifier {
...
impl Serialize for ReplaceCustomPaymentMethodRequestApplicationJsonPropertyModifier {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ReplaceCustomPaymentMethodRequestApplicationJsonPropertyModifier {
...
impl ReplaceCustomPaymentMethodRequestApplicationJsonPropertyModifier {
