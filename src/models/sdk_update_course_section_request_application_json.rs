...
#[serde(remote = "Self")]
pub struct SdkUpdateCourseSectionRequestApplicationJson {
...
impl Serialize for SdkUpdateCourseSectionRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkUpdateCourseSectionRequestApplicationJson {
...
impl SdkUpdateCourseSectionRequestApplicationJson {
    ...
    pub fn validate_request(&self) -> Result<(), crate::error::Error> {
        ...
        crate::runtime_schema::model(&value, "SdkUpdateCourseSectionRequestApplicationJson", true)
    }
}
