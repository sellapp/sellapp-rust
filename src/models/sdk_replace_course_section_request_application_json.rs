...
#[serde(remote = "Self")]
pub struct SdkReplaceCourseSectionRequestApplicationJson {
...
impl Serialize for SdkReplaceCourseSectionRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkReplaceCourseSectionRequestApplicationJson {
...
impl SdkReplaceCourseSectionRequestApplicationJson {
