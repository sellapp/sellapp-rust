...
#[serde(remote = "Self")]
pub struct CancelAppointmentResponseValue200ApplicationJsonPropertyDataPropertyProduct {
    #[serde(
...
impl Serialize for CancelAppointmentResponseValue200ApplicationJsonPropertyDataPropertyProduct {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for CancelAppointmentResponseValue200ApplicationJsonPropertyDataPropertyProduct
{
...
impl CancelAppointmentResponseValue200ApplicationJsonPropertyDataPropertyProduct {
