...
#[serde(remote = "Self")]
pub struct SdkV2ReplyToFeedbackResponseValue200ApplicationJson {
    pub data: V2ReplyToFeedbackResponseValue200ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkV2ReplyToFeedbackResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkV2ReplyToFeedbackResponseValue200ApplicationJson {
...
impl SdkV2ReplyToFeedbackResponseValue200ApplicationJson {
