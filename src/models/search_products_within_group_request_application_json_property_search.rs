...
#[serde(remote = "Self")]
pub struct SearchProductsWithinGroupRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchProductsWithinGroupRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchProductsWithinGroupRequestApplicationJsonPropertySearch {
...
impl SearchProductsWithinGroupRequestApplicationJsonPropertySearch {
