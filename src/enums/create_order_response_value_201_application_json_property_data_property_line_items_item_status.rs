...
#[non_exhaustive]
pub enum CreateOrderResponseValue201ApplicationJsonPropertyDataPropertyLineItemsItemStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl CreateOrderResponseValue201ApplicationJsonPropertyDataPropertyLineItemsItemStatus {
...
impl fmt::Display
    for CreateOrderResponseValue201ApplicationJsonPropertyDataPropertyLineItemsItemStatus
{
...
impl FromStr for CreateOrderResponseValue201ApplicationJsonPropertyDataPropertyLineItemsItemStatus {
