...
#[serde(remote = "Self")]
pub struct SdkRecordCreditTransactionRequestApplicationJson {
    pub customer_id: i64,
    pub product_id: i64,
    pub kind: SdkRecordCreditTransactionRequestApplicationJsonKind,
    ...
    pub metadata: Option<RecordCreditTransactionRequestApplicationJsonPropertyMetadata>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkRecordCreditTransactionRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkRecordCreditTransactionRequestApplicationJson {
...
impl SdkRecordCreditTransactionRequestApplicationJson {
