...
#[serde(remote = "Self")]
pub struct ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue1 {
    /// Write-only secret. SellApp never returns the stored value.
    pub merchant_secure_key: String,
    /// Write-only secret. SellApp never returns the stored value.
    pub merchant_tokenization_key: String,
    /// Write-only secret. SellApp never returns the stored value.
...
impl Serialize for ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue1 {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue1
{
...
impl ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue1 {
