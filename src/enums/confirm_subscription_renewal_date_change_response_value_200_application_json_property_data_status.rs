...
#[non_exhaustive]
pub enum ConfirmSubscriptionRenewalDateChangeResponseValue200ApplicationJsonPropertyDataStatus {
    Pending,
    Confirmed,
    Failed,
    Expired,
...
impl ConfirmSubscriptionRenewalDateChangeResponseValue200ApplicationJsonPropertyDataStatus {
...
impl fmt::Display
    for ConfirmSubscriptionRenewalDateChangeResponseValue200ApplicationJsonPropertyDataStatus
{
