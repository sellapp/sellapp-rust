...
#[serde(remote = "Self")]
pub struct ListFeedbackResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
    pub feedback: String,
    pub rating: i64,
    ...
    pub store_id: i64,
    pub metadata:
        Option<ListFeedbackResponseValue200ApplicationJsonPropertyDataItemPropertyMetadata>,
    pub message: String,
...
impl Serialize for ListFeedbackResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ListFeedbackResponseValue200ApplicationJsonPropertyDataItem {
...
impl ListFeedbackResponseValue200ApplicationJsonPropertyDataItem {
