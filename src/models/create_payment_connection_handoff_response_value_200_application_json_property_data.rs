...
#[serde(remote = "Self")]
pub struct CreatePaymentConnectionHandoffResponseValue200ApplicationJsonPropertyData {
...
impl Serialize for CreatePaymentConnectionHandoffResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for CreatePaymentConnectionHandoffResponseValue200ApplicationJsonPropertyData
{
...
impl CreatePaymentConnectionHandoffResponseValue200ApplicationJsonPropertyData {
