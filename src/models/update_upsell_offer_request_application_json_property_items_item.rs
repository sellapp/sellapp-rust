...
#[serde(remote = "Self")]
pub struct UpdateUpsellOfferRequestApplicationJsonPropertyItemsItem {
...
impl Serialize for UpdateUpsellOfferRequestApplicationJsonPropertyItemsItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for UpdateUpsellOfferRequestApplicationJsonPropertyItemsItem {
...
impl UpdateUpsellOfferRequestApplicationJsonPropertyItemsItem {
