...
#[serde(remote = "Self")]
pub struct ListFeedbackResponseValue200ApplicationJsonPropertyDataItemPropertyMetadata {
...
impl Serialize for ListFeedbackResponseValue200ApplicationJsonPropertyDataItemPropertyMetadata {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ListFeedbackResponseValue200ApplicationJsonPropertyDataItemPropertyMetadata
{
...
impl ListFeedbackResponseValue200ApplicationJsonPropertyDataItemPropertyMetadata {
