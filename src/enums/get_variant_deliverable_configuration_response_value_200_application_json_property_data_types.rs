...
#[non_exhaustive]
pub enum GetVariantDeliverableConfigurationResponseValue200ApplicationJsonPropertyDataTypes {
    Downloadable,
    Text,
    Dynamic,
    Manual,
...
impl GetVariantDeliverableConfigurationResponseValue200ApplicationJsonPropertyDataTypes {
...
impl fmt::Display
    for GetVariantDeliverableConfigurationResponseValue200ApplicationJsonPropertyDataTypes
{
