...
#[serde(remote = "Self")]
pub struct CreateOrderCheckoutResponseValue201ApplicationJsonPropertyDataPropertyPayment {
...
impl Serialize for CreateOrderCheckoutResponseValue201ApplicationJsonPropertyDataPropertyPayment {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for CreateOrderCheckoutResponseValue201ApplicationJsonPropertyDataPropertyPayment
{
...
impl CreateOrderCheckoutResponseValue201ApplicationJsonPropertyDataPropertyPayment {
