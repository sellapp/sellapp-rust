...
#[serde(remote = "Self")]
pub struct SearchCustomersRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchCustomersRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchCustomersRequestApplicationJsonPropertySearch {
...
impl SearchCustomersRequestApplicationJsonPropertySearch {
