...
#[non_exhaustive]
pub enum CreateOrderResponseValue201ApplicationJsonPropertyDataPropertyTimelineItemStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl CreateOrderResponseValue201ApplicationJsonPropertyDataPropertyTimelineItemStatus {
...
impl fmt::Display
    for CreateOrderResponseValue201ApplicationJsonPropertyDataPropertyTimelineItemStatus
{
...
impl FromStr for CreateOrderResponseValue201ApplicationJsonPropertyDataPropertyTimelineItemStatus {
