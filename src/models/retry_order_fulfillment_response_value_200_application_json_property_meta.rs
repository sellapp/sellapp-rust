...
#[serde(remote = "Self")]
pub struct RetryOrderFulfillmentResponseValue200ApplicationJsonPropertyMeta {
    pub effects_reset: i64,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for RetryOrderFulfillmentResponseValue200ApplicationJsonPropertyMeta {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for RetryOrderFulfillmentResponseValue200ApplicationJsonPropertyMeta {
...
impl RetryOrderFulfillmentResponseValue200ApplicationJsonPropertyMeta {
