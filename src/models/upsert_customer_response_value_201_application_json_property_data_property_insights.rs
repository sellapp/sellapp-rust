...
#[serde(remote = "Self")]
pub struct UpsertCustomerResponseValue201ApplicationJsonPropertyDataPropertyInsights {
...
impl Serialize for UpsertCustomerResponseValue201ApplicationJsonPropertyDataPropertyInsights {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for UpsertCustomerResponseValue201ApplicationJsonPropertyDataPropertyInsights
{
...
impl UpsertCustomerResponseValue201ApplicationJsonPropertyDataPropertyInsights {
