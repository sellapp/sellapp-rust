...
#[serde(remote = "Self")]
pub struct V2ReplaceCouponResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: V2ReplaceCouponResponseValue200ApplicationJsonPropertyDataType,
    pub discount: String,
...
impl Serialize for V2ReplaceCouponResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2ReplaceCouponResponseValue200ApplicationJsonPropertyData {
...
impl V2ReplaceCouponResponseValue200ApplicationJsonPropertyData {
