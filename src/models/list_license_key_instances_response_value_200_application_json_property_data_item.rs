...
#[serde(remote = "Self")]
pub struct ListLicenseKeyInstancesResponseValue200ApplicationJsonPropertyDataItem {
    pub id: String,
...
impl Serialize for ListLicenseKeyInstancesResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ListLicenseKeyInstancesResponseValue200ApplicationJsonPropertyDataItem
{
...
impl ListLicenseKeyInstancesResponseValue200ApplicationJsonPropertyDataItem {
