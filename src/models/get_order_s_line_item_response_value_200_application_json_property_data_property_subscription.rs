...
#[serde(remote = "Self")]
pub struct GetOrderSLineItemResponseValue200ApplicationJsonPropertyDataPropertySubscription {
    pub id: i64,
...
impl Serialize
    for GetOrderSLineItemResponseValue200ApplicationJsonPropertyDataPropertySubscription
{
...
impl GetOrderSLineItemResponseValue200ApplicationJsonPropertyDataPropertySubscription {
