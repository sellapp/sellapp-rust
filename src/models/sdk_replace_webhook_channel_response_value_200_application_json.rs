...
#[serde(remote = "Self")]
pub struct SdkReplaceWebhookChannelResponseValue200ApplicationJson {
    pub data: ReplaceWebhookChannelResponseValue200ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkReplaceWebhookChannelResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkReplaceWebhookChannelResponseValue200ApplicationJson {
...
impl SdkReplaceWebhookChannelResponseValue200ApplicationJson {
