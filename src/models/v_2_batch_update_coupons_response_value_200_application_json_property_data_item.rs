...
#[serde(remote = "Self")]
pub struct V2BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: V2BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItemType,
    pub discount: String,
...
impl Serialize for V2BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItem {
...
impl V2BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItem {
