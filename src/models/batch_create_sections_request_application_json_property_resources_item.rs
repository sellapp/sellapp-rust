...
#[serde(remote = "Self")]
pub struct BatchCreateSectionsRequestApplicationJsonPropertyResourcesItem {
    pub title: String,
    pub hidden: bool,
...
impl Serialize for BatchCreateSectionsRequestApplicationJsonPropertyResourcesItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for BatchCreateSectionsRequestApplicationJsonPropertyResourcesItem {
...
impl BatchCreateSectionsRequestApplicationJsonPropertyResourcesItem {
