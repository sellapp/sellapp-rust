...
#[serde(remote = "Self")]
pub struct SdkV2ReplaceSectionProductsRequestApplicationJson {
    pub resources: Vec<i64>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkV2ReplaceSectionProductsRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkV2ReplaceSectionProductsRequestApplicationJson {
...
impl SdkV2ReplaceSectionProductsRequestApplicationJson {
