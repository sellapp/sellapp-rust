...
#[non_exhaustive]
pub enum SdkReplaceCourseRequestApplicationJsonLevel {
    AllLevels,
    Beginner,
    Intermediate,
    Advanced,
...
impl SdkReplaceCourseRequestApplicationJsonLevel {
...
impl fmt::Display for SdkReplaceCourseRequestApplicationJsonLevel {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkReplaceCourseRequestApplicationJsonLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkReplaceCourseRequestApplicationJsonLevel {
...
impl From<String> for SdkReplaceCourseRequestApplicationJsonLevel {
...
impl From<&str> for SdkReplaceCourseRequestApplicationJsonLevel {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkReplaceCourseRequestApplicationJsonLevel {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkReplaceCourseRequestApplicationJsonLevel {
