...
#[non_exhaustive]
pub enum SdkUpdateTicketRequestApplicationJsonStatus {
    Open,
    Closed,
...
impl SdkUpdateTicketRequestApplicationJsonStatus {
...
impl fmt::Display for SdkUpdateTicketRequestApplicationJsonStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkUpdateTicketRequestApplicationJsonStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkUpdateTicketRequestApplicationJsonStatus {
...
impl From<String> for SdkUpdateTicketRequestApplicationJsonStatus {
...
impl From<&str> for SdkUpdateTicketRequestApplicationJsonStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkUpdateTicketRequestApplicationJsonStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkUpdateTicketRequestApplicationJsonStatus {
