...
#[serde(remote = "Self")]
pub struct SdkCreateFulfillmentRetryRequestApplicationJson {
...
impl Serialize for SdkCreateFulfillmentRetryRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateFulfillmentRetryRequestApplicationJson {
...
impl SdkCreateFulfillmentRetryRequestApplicationJson {
