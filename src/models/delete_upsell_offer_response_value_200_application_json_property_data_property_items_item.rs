...
#[serde(remote = "Self")]
pub struct DeleteUpsellOfferResponseValue200ApplicationJsonPropertyDataPropertyItemsItem {
    pub id: i64,
    ...
    pub sort_order: i64,
    pub target_product: Option<DeleteUpsellOfferResponseValue200ApplicationJsonPropertyDataPropertyItemsItemPropertyTargetProduct>,
    pub target_variant: Option<DeleteUpsellOfferResponseValue200ApplicationJsonPropertyDataPropertyItemsItemPropertyTargetVariant>,
...
impl Serialize for DeleteUpsellOfferResponseValue200ApplicationJsonPropertyDataPropertyItemsItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for DeleteUpsellOfferResponseValue200ApplicationJsonPropertyDataPropertyItemsItem
{
...
impl DeleteUpsellOfferResponseValue200ApplicationJsonPropertyDataPropertyItemsItem {
