...
#[serde(remote = "Self")]
pub struct CreateProductVariantRequestApplicationJsonPropertyBulkDiscountItem {
...
impl Serialize for CreateProductVariantRequestApplicationJsonPropertyBulkDiscountItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateProductVariantRequestApplicationJsonPropertyBulkDiscountItem {
...
impl CreateProductVariantRequestApplicationJsonPropertyBulkDiscountItem {
