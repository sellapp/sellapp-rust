...
#[non_exhaustive]
pub enum SdkUpdateProductVariantRequestApplicationJsonPaymentMethods {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl SdkUpdateProductVariantRequestApplicationJsonPaymentMethods {
...
impl fmt::Display for SdkUpdateProductVariantRequestApplicationJsonPaymentMethods {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkUpdateProductVariantRequestApplicationJsonPaymentMethods {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkUpdateProductVariantRequestApplicationJsonPaymentMethods {
...
impl From<String> for SdkUpdateProductVariantRequestApplicationJsonPaymentMethods {
...
impl From<&str> for SdkUpdateProductVariantRequestApplicationJsonPaymentMethods {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkUpdateProductVariantRequestApplicationJsonPaymentMethods {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkUpdateProductVariantRequestApplicationJsonPaymentMethods {
