...
impl fmt::Display for IncentiveMode {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for IncentiveMode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for IncentiveMode {
...
impl From<String> for IncentiveMode {
...
impl From<&str> for IncentiveMode {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for IncentiveMode {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for IncentiveMode {
