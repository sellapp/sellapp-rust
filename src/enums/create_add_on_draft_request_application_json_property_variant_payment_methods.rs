...
#[non_exhaustive]
pub enum CreateAddOnDraftRequestApplicationJsonPropertyVariantPaymentMethods {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl CreateAddOnDraftRequestApplicationJsonPropertyVariantPaymentMethods {
...
impl fmt::Display for CreateAddOnDraftRequestApplicationJsonPropertyVariantPaymentMethods {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for CreateAddOnDraftRequestApplicationJsonPropertyVariantPaymentMethods {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for CreateAddOnDraftRequestApplicationJsonPropertyVariantPaymentMethods {
...
impl From<String> for CreateAddOnDraftRequestApplicationJsonPropertyVariantPaymentMethods {
...
impl From<&str> for CreateAddOnDraftRequestApplicationJsonPropertyVariantPaymentMethods {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for CreateAddOnDraftRequestApplicationJsonPropertyVariantPaymentMethods {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for CreateAddOnDraftRequestApplicationJsonPropertyVariantPaymentMethods {
