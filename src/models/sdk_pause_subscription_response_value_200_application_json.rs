...
#[serde(remote = "Self")]
pub struct SdkPauseSubscriptionResponseValue200ApplicationJson {
    pub data: PauseSubscriptionResponseValue200ApplicationJsonPropertyData,
    pub message: String,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkPauseSubscriptionResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkPauseSubscriptionResponseValue200ApplicationJson {
...
impl SdkPauseSubscriptionResponseValue200ApplicationJson {
