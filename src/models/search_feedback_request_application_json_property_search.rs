...
#[serde(remote = "Self")]
pub struct SearchFeedbackRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchFeedbackRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchFeedbackRequestApplicationJsonPropertySearch {
...
impl SearchFeedbackRequestApplicationJsonPropertySearch {
