...
#[serde(remote = "Self")]
pub struct GetCouponResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: GetCouponResponseValue200ApplicationJsonPropertyDataType,
    pub discount: String,
...
impl Serialize for GetCouponResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for GetCouponResponseValue200ApplicationJsonPropertyData {
...
impl GetCouponResponseValue200ApplicationJsonPropertyData {
