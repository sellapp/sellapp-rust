...
#[non_exhaustive]
pub enum SdkSearchInvoicesRequestApplicationJsonStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl SdkSearchInvoicesRequestApplicationJsonStatus {
...
impl fmt::Display for SdkSearchInvoicesRequestApplicationJsonStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkSearchInvoicesRequestApplicationJsonStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkSearchInvoicesRequestApplicationJsonStatus {
...
impl From<String> for SdkSearchInvoicesRequestApplicationJsonStatus {
...
impl From<&str> for SdkSearchInvoicesRequestApplicationJsonStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkSearchInvoicesRequestApplicationJsonStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkSearchInvoicesRequestApplicationJsonStatus {
