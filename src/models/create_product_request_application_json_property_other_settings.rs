...
#[serde(remote = "Self")]
pub struct CreateProductRequestApplicationJsonPropertyOtherSettings {
...
impl Serialize for CreateProductRequestApplicationJsonPropertyOtherSettings {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateProductRequestApplicationJsonPropertyOtherSettings {
...
impl CreateProductRequestApplicationJsonPropertyOtherSettings {
