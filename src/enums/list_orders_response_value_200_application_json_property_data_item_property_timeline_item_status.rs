...
#[non_exhaustive]
pub enum ListOrdersResponseValue200ApplicationJsonPropertyDataItemPropertyTimelineItemStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl ListOrdersResponseValue200ApplicationJsonPropertyDataItemPropertyTimelineItemStatus {
...
impl fmt::Display
    for ListOrdersResponseValue200ApplicationJsonPropertyDataItemPropertyTimelineItemStatus
{
