...
#[serde(remote = "Self")]
pub struct MarkPendingInvoiceCompletedResponseValue200ApplicationJsonPropertyWebhooksItem {
    pub url: String,
...
impl Serialize for MarkPendingInvoiceCompletedResponseValue200ApplicationJsonPropertyWebhooksItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for MarkPendingInvoiceCompletedResponseValue200ApplicationJsonPropertyWebhooksItem
{
...
impl MarkPendingInvoiceCompletedResponseValue200ApplicationJsonPropertyWebhooksItem {
