...
#[serde(remote = "Self")]
pub struct SdkUpdateProductVariantPricingRequestApplicationJson {
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub pricing: Option<UpdateProductVariantPricingRequestApplicationJsonPropertyPricing>,
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub payment_methods:
        Option<Vec<SdkUpdateProductVariantPricingRequestApplicationJsonPaymentMethods>>,
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub bulk_discount:
        Option<Vec<UpdateProductVariantPricingRequestApplicationJsonPropertyBulkDiscountItem>>,
...
impl Serialize for SdkUpdateProductVariantPricingRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkUpdateProductVariantPricingRequestApplicationJson {
...
impl SdkUpdateProductVariantPricingRequestApplicationJson {
