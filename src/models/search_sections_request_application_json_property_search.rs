...
#[serde(remote = "Self")]
pub struct SearchSectionsRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchSectionsRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchSectionsRequestApplicationJsonPropertySearch {
...
impl SearchSectionsRequestApplicationJsonPropertySearch {
