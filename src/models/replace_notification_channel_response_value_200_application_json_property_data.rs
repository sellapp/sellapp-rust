...
#[serde(remote = "Self")]
pub struct ReplaceNotificationChannelResponseValue200ApplicationJsonPropertyData {
    ...
    pub id: String,
    #[serde(rename = "type")]
    pub type_: ReplaceNotificationChannelResponseValue200ApplicationJsonPropertyDataType,
    #[serde(
...
impl Serialize for ReplaceNotificationChannelResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ReplaceNotificationChannelResponseValue200ApplicationJsonPropertyData
{
...
impl ReplaceNotificationChannelResponseValue200ApplicationJsonPropertyData {
