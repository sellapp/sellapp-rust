...
#[serde(remote = "Self")]
pub struct SdkReplaceHighlightMediaRequestMultipartFormData {
    pub file: Vec<u8>,
...
impl Serialize for SdkReplaceHighlightMediaRequestMultipartFormData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkReplaceHighlightMediaRequestMultipartFormData {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let mut value = serde_json::Value::deserialize(deserializer)?;
        crate::runtime_schema::model(
            &value,
            "SdkReplaceHighlightMediaRequestMultipartFormData",
            false,
        )
...
impl SdkReplaceHighlightMediaRequestMultipartFormData {
