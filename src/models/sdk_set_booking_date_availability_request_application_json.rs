...
#[serde(remote = "Self")]
pub struct SdkSetBookingDateAvailabilityRequestApplicationJson {
    #[serde(
        skip_serializing_if = "Option::is_none",
        default,
        deserialize_with = "crate::runtime_schema::present_nullable"
    )]
    pub product_variant_id: Option<Option<i64>>,
...
impl Serialize for SdkSetBookingDateAvailabilityRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkSetBookingDateAvailabilityRequestApplicationJson {
...
impl SdkSetBookingDateAvailabilityRequestApplicationJson {
