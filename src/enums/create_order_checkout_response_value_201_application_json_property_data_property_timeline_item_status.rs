...
#[non_exhaustive]
pub enum CreateOrderCheckoutResponseValue201ApplicationJsonPropertyDataPropertyTimelineItemStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl CreateOrderCheckoutResponseValue201ApplicationJsonPropertyDataPropertyTimelineItemStatus {
...
impl fmt::Display
    for CreateOrderCheckoutResponseValue201ApplicationJsonPropertyDataPropertyTimelineItemStatus
{
