...
#[non_exhaustive]
pub enum ReplaceMarketingSettingsRequestApplicationJsonPropertyAbandonedCartIncentiveMode {
    None,
    ExistingCoupon,
    Null,
...
impl ReplaceMarketingSettingsRequestApplicationJsonPropertyAbandonedCartIncentiveMode {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            Self::None => "none",
            Self::ExistingCoupon => "existing_coupon",
            Self::Null => "null",
...
impl fmt::Display
    for ReplaceMarketingSettingsRequestApplicationJsonPropertyAbandonedCartIncentiveMode
{
...
impl FromStr for ReplaceMarketingSettingsRequestApplicationJsonPropertyAbandonedCartIncentiveMode {
    type Err = std::convert::Infallible;
    #[allow(deprecated)]
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            "none" => Self::None,
            "existing_coupon" => Self::ExistingCoupon,
            "null" => Self::Null,
