...
#[serde(remote = "Self")]
pub struct UpdateCustomerWalletStatusResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub customer_id: i64,
    ...
    pub status: UpdateCustomerWalletStatusResponseValue200ApplicationJsonPropertyDataStatus,
    #[serde(
...
impl Serialize for UpdateCustomerWalletStatusResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for UpdateCustomerWalletStatusResponseValue200ApplicationJsonPropertyData
{
...
impl UpdateCustomerWalletStatusResponseValue200ApplicationJsonPropertyData {
