...
#[serde(remote = "Self")]
pub struct UpdateNotificationChannelResponseValue200ApplicationJsonPropertyData {
    ...
    pub id: String,
    #[serde(rename = "type")]
    pub type_: UpdateNotificationChannelResponseValue200ApplicationJsonPropertyDataType,
    #[serde(
...
impl Serialize for UpdateNotificationChannelResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for UpdateNotificationChannelResponseValue200ApplicationJsonPropertyData
{
...
impl UpdateNotificationChannelResponseValue200ApplicationJsonPropertyData {
