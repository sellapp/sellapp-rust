...
#[non_exhaustive]
pub enum SdkCreateChargeRequestApplicationJsonPaymentMethods {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl SdkCreateChargeRequestApplicationJsonPaymentMethods {
...
impl fmt::Display for SdkCreateChargeRequestApplicationJsonPaymentMethods {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkCreateChargeRequestApplicationJsonPaymentMethods {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkCreateChargeRequestApplicationJsonPaymentMethods {
...
impl From<String> for SdkCreateChargeRequestApplicationJsonPaymentMethods {
...
impl From<&str> for SdkCreateChargeRequestApplicationJsonPaymentMethods {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkCreateChargeRequestApplicationJsonPaymentMethods {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkCreateChargeRequestApplicationJsonPaymentMethods {
