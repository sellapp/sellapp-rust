...
#[serde(remote = "Self")]
pub struct ValidateLicenseKeyResponseValue200ApplicationJsonPropertyData {
    pub valid: bool,
    pub license_key:
        ValidateLicenseKeyResponseValue200ApplicationJsonPropertyDataPropertyLicenseKey,
    pub instance:
        Option<ValidateLicenseKeyResponseValue200ApplicationJsonPropertyDataPropertyInstance>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for ValidateLicenseKeyResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ValidateLicenseKeyResponseValue200ApplicationJsonPropertyData {
...
impl ValidateLicenseKeyResponseValue200ApplicationJsonPropertyData {
