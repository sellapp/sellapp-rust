...
#[serde(remote = "Self")]
pub struct ListWebhookChannelsResponseValue200ApplicationJsonPropertyDataItem {
    ...
    pub allowed_notifications:
        Vec<ListWebhookChannelsResponseValue200ApplicationJsonPropertyDataItemAllowedNotifications>,
...
impl Serialize for ListWebhookChannelsResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ListWebhookChannelsResponseValue200ApplicationJsonPropertyDataItem {
...
impl ListWebhookChannelsResponseValue200ApplicationJsonPropertyDataItem {
