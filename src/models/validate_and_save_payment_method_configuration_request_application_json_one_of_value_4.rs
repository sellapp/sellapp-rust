...
#[serde(remote = "Self")]
pub struct ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue4 {
...
impl Serialize for ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue4 {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue4
{
...
impl ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue4 {
