...
#[serde(remote = "Self")]
pub struct SdkCreateExportResponseValue201ApplicationJson {
    pub data: CreateExportResponseValue201ApplicationJsonPropertyData,
    pub meta: CreateExportResponseValue201ApplicationJsonPropertyMeta,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkCreateExportResponseValue201ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateExportResponseValue201ApplicationJson {
...
impl SdkCreateExportResponseValue201ApplicationJson {
