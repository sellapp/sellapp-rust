...
#[serde(remote = "Self")]
pub struct CreateWalletOrderResponseValue201ApplicationJsonPropertyDataPropertyPayment {
...
impl Serialize for CreateWalletOrderResponseValue201ApplicationJsonPropertyDataPropertyPayment {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for CreateWalletOrderResponseValue201ApplicationJsonPropertyDataPropertyPayment
{
...
impl CreateWalletOrderResponseValue201ApplicationJsonPropertyDataPropertyPayment {
