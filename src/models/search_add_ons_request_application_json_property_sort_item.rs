...
#[serde(remote = "Self")]
pub struct SearchAddOnsRequestApplicationJsonPropertySortItem {
    pub field: String,
    /// Defaults to `asc`.
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub direction: Option<SearchAddOnsRequestApplicationJsonPropertySortItemDirection>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SearchAddOnsRequestApplicationJsonPropertySortItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchAddOnsRequestApplicationJsonPropertySortItem {
...
impl SearchAddOnsRequestApplicationJsonPropertySortItem {
