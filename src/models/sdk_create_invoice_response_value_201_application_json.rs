...
#[serde(remote = "Self")]
pub struct SdkCreateInvoiceResponseValue201ApplicationJson {
    pub data: CreateInvoiceResponseValue201ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkCreateInvoiceResponseValue201ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateInvoiceResponseValue201ApplicationJson {
...
impl SdkCreateInvoiceResponseValue201ApplicationJson {
