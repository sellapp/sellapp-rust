...
#[serde(remote = "Self")]
pub struct GetNotificationChannelResponseValue200ApplicationJsonPropertyData {
    ...
    pub id: String,
    #[serde(rename = "type")]
    pub type_: GetNotificationChannelResponseValue200ApplicationJsonPropertyDataType,
    #[serde(
...
impl Serialize for GetNotificationChannelResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for GetNotificationChannelResponseValue200ApplicationJsonPropertyData {
...
impl GetNotificationChannelResponseValue200ApplicationJsonPropertyData {
