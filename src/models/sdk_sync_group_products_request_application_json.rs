...
#[serde(remote = "Self")]
pub struct SdkSyncGroupProductsRequestApplicationJson {
...
impl Serialize for SdkSyncGroupProductsRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkSyncGroupProductsRequestApplicationJson {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let mut value = serde_json::Value::deserialize(deserializer)?;
        crate::runtime_schema::model(&value, "SdkSyncGroupProductsRequestApplicationJson", false)
...
impl SdkSyncGroupProductsRequestApplicationJson {
    ...
    pub fn validate_request(&self) -> Result<(), crate::error::Error> {
        ...
        crate::runtime_schema::model(&value, "SdkSyncGroupProductsRequestApplicationJson", true)
    }
}
