...
#[serde(remote = "Self")]
pub struct BatchCreateCouponsResponseValue201ApplicationJsonPropertyDataItem {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: BatchCreateCouponsResponseValue201ApplicationJsonPropertyDataItemType,
    pub discount: String,
...
impl Serialize for BatchCreateCouponsResponseValue201ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for BatchCreateCouponsResponseValue201ApplicationJsonPropertyDataItem {
...
impl BatchCreateCouponsResponseValue201ApplicationJsonPropertyDataItem {
