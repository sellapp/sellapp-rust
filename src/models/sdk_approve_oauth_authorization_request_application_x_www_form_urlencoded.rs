...
#[serde(remote = "Self")]
pub struct SdkApproveOAuthAuthorizationRequestApplicationXWwwFormUrlencoded {
    pub auth_token: crate::SecretString,
...
impl Serialize for SdkApproveOAuthAuthorizationRequestApplicationXWwwFormUrlencoded {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkApproveOAuthAuthorizationRequestApplicationXWwwFormUrlencoded {
...
impl SdkApproveOAuthAuthorizationRequestApplicationXWwwFormUrlencoded {
