...
#[non_exhaustive]
pub enum SdkReplaceCreditsProductRequestApplicationJsonPaymentMethods {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl SdkReplaceCreditsProductRequestApplicationJsonPaymentMethods {
...
impl fmt::Display for SdkReplaceCreditsProductRequestApplicationJsonPaymentMethods {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkReplaceCreditsProductRequestApplicationJsonPaymentMethods {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkReplaceCreditsProductRequestApplicationJsonPaymentMethods {
...
impl From<String> for SdkReplaceCreditsProductRequestApplicationJsonPaymentMethods {
...
impl From<&str> for SdkReplaceCreditsProductRequestApplicationJsonPaymentMethods {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkReplaceCreditsProductRequestApplicationJsonPaymentMethods {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkReplaceCreditsProductRequestApplicationJsonPaymentMethods {
