...
#[serde(remote = "Self")]
pub struct SdkReplaceCustomPaymentMethodRequestApplicationJson {
    #[serde(rename = "type")]
    pub type_: SdkReplaceCustomPaymentMethodRequestApplicationJsonType,
    pub name: String,
    #[serde(
    ...
    pub modifier: Option<Option<ReplaceCustomPaymentMethodRequestApplicationJsonPropertyModifier>>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkReplaceCustomPaymentMethodRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkReplaceCustomPaymentMethodRequestApplicationJson {
...
impl SdkReplaceCustomPaymentMethodRequestApplicationJson {
