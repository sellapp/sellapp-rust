...
#[serde(remote = "Self")]
pub struct ReplaceVariantDeliverableFolderSettingsResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub name: String,
    #[serde(
...
impl Serialize
    for ReplaceVariantDeliverableFolderSettingsResponseValue200ApplicationJsonPropertyData
{
...
impl ReplaceVariantDeliverableFolderSettingsResponseValue200ApplicationJsonPropertyData {
