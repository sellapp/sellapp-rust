...
#[non_exhaustive]
pub enum UpdateCourseSectionResponseValue200ApplicationJsonPropertyDataPropertyLessonsItemType {
    Lecture,
    Video,
    Text,
    Quiz,
...
impl UpdateCourseSectionResponseValue200ApplicationJsonPropertyDataPropertyLessonsItemType {
...
impl fmt::Display
    for UpdateCourseSectionResponseValue200ApplicationJsonPropertyDataPropertyLessonsItemType
{
