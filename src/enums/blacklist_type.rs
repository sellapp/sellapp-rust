...
impl BlacklistType {
    ...
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Self::Email => "EMAIL",
            Self::Ip => "IP",
            Self::WildcardEmail => "WILDCARD_EMAIL",
...
impl fmt::Display for BlacklistType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for BlacklistType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for BlacklistType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        Ok(match s {
            ...
            "EMAIL" => Self::Email,
            "IP" => Self::Ip,
            "WILDCARD_EMAIL" => Self::WildcardEmail,
            other => Self::Unknown(other.to_string()),
        })
    }
}

impl From<String> for BlacklistType {
...
impl From<&str> for BlacklistType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for BlacklistType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for BlacklistType {
