...
#[serde(remote = "Self")]
pub struct CreateWalletOrderRequestApplicationJsonPropertyExtra {
    pub amount: i64,
    pub currency: String,
...
impl Serialize for CreateWalletOrderRequestApplicationJsonPropertyExtra {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateWalletOrderRequestApplicationJsonPropertyExtra {
...
impl CreateWalletOrderRequestApplicationJsonPropertyExtra {
