...
#[serde(remote = "Self")]
pub struct ListCouponsResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: ListCouponsResponseValue200ApplicationJsonPropertyDataItemType,
    pub discount: String,
...
impl Serialize for ListCouponsResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ListCouponsResponseValue200ApplicationJsonPropertyDataItem {
...
impl ListCouponsResponseValue200ApplicationJsonPropertyDataItem {
