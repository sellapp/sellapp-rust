...
#[serde(remote = "Self")]
pub struct SdkResumeCustomerSubscriptionRequestApplicationJson {
...
impl Serialize for SdkResumeCustomerSubscriptionRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkResumeCustomerSubscriptionRequestApplicationJson {
...
impl SdkResumeCustomerSubscriptionRequestApplicationJson {
