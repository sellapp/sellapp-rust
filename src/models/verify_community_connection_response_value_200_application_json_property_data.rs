...
#[serde(remote = "Self")]
pub struct VerifyCommunityConnectionResponseValue200ApplicationJsonPropertyData {
    pub platform: VerifyCommunityConnectionResponseValue200ApplicationJsonPropertyDataPlatform,
    pub healthy_count: i64,
    pub issue_count: i64,
    pub retried_count: i64,
    pub skipped_count: i64,
    pub skipped_products: Vec<String>,
    pub unchanged_products: Vec<String>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for VerifyCommunityConnectionResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for VerifyCommunityConnectionResponseValue200ApplicationJsonPropertyData
{
...
impl VerifyCommunityConnectionResponseValue200ApplicationJsonPropertyData {
