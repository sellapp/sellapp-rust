...
#[serde(remote = "Self")]
pub struct SdkDeleteCreditsProductRequestApplicationJson {
...
impl Serialize for SdkDeleteCreditsProductRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkDeleteCreditsProductRequestApplicationJson {
...
impl SdkDeleteCreditsProductRequestApplicationJson {
