...
#[non_exhaustive]
pub enum SearchOrdersResponseValue200ApplicationJsonPropertyDataItemPropertyTimelineItemStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl SearchOrdersResponseValue200ApplicationJsonPropertyDataItemPropertyTimelineItemStatus {
...
impl fmt::Display
    for SearchOrdersResponseValue200ApplicationJsonPropertyDataItemPropertyTimelineItemStatus
{
