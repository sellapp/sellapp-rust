...
#[serde(remote = "Self")]
pub struct V2SearchFeedbackRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for V2SearchFeedbackRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2SearchFeedbackRequestApplicationJsonPropertySearch {
...
impl V2SearchFeedbackRequestApplicationJsonPropertySearch {
