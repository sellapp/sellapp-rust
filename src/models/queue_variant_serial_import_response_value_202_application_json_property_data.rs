...
#[serde(remote = "Self")]
pub struct QueueVariantSerialImportResponseValue202ApplicationJsonPropertyData {
    pub status: String,
...
impl Serialize for QueueVariantSerialImportResponseValue202ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for QueueVariantSerialImportResponseValue202ApplicationJsonPropertyData {
...
impl QueueVariantSerialImportResponseValue202ApplicationJsonPropertyData {
