...
#[non_exhaustive]
pub enum ReplaceCourseSectionResponseValue200ApplicationJsonPropertyDataPropertyLessonsItemType {
    Lecture,
    Video,
    Text,
    Quiz,
...
impl ReplaceCourseSectionResponseValue200ApplicationJsonPropertyDataPropertyLessonsItemType {
...
impl fmt::Display
    for ReplaceCourseSectionResponseValue200ApplicationJsonPropertyDataPropertyLessonsItemType
{
