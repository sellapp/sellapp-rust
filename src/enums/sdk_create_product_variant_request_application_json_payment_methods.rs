...
#[non_exhaustive]
pub enum SdkCreateProductVariantRequestApplicationJsonPaymentMethods {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl SdkCreateProductVariantRequestApplicationJsonPaymentMethods {
...
impl fmt::Display for SdkCreateProductVariantRequestApplicationJsonPaymentMethods {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkCreateProductVariantRequestApplicationJsonPaymentMethods {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkCreateProductVariantRequestApplicationJsonPaymentMethods {
...
impl From<String> for SdkCreateProductVariantRequestApplicationJsonPaymentMethods {
...
impl From<&str> for SdkCreateProductVariantRequestApplicationJsonPaymentMethods {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkCreateProductVariantRequestApplicationJsonPaymentMethods {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkCreateProductVariantRequestApplicationJsonPaymentMethods {
