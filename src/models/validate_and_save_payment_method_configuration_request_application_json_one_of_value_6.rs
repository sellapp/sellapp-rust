...
#[serde(remote = "Self")]
pub struct ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue6 {
    pub destination_gateway: String,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue6 {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue6
{
...
impl ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue6 {
