...
#[serde(remote = "Self")]
pub struct UpdateInvoiceStatusResponseValue200ApplicationJsonPropertyWebhooksItem {
    pub url: String,
...
impl Serialize for UpdateInvoiceStatusResponseValue200ApplicationJsonPropertyWebhooksItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for UpdateInvoiceStatusResponseValue200ApplicationJsonPropertyWebhooksItem
{
...
impl UpdateInvoiceStatusResponseValue200ApplicationJsonPropertyWebhooksItem {
