...
#[serde(remote = "Self")]
pub struct SdkGetAffiliatePayoutResponseValue200ApplicationJson {
    pub data: GetAffiliatePayoutResponseValue200ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkGetAffiliatePayoutResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkGetAffiliatePayoutResponseValue200ApplicationJson {
...
impl SdkGetAffiliatePayoutResponseValue200ApplicationJson {
