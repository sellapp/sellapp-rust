...
#[serde(remote = "Self")]
pub struct PollCommunityConnectionResponseValue200ApplicationJsonPropertyDataPropertyServer {
    pub id: String,
    pub name: String,
    #[serde(rename = "type")]
    ...
    pub roles: Vec<PollCommunityConnectionResponseValue200ApplicationJsonPropertyDataPropertyServerAnyOfValue1PropertyRolesItem>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize
    for PollCommunityConnectionResponseValue200ApplicationJsonPropertyDataPropertyServer
{
...
impl PollCommunityConnectionResponseValue200ApplicationJsonPropertyDataPropertyServer {
