...
#[serde(remote = "Self")]
pub struct GetSubscriptionCapabilitiesResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
...
impl Serialize for GetSubscriptionCapabilitiesResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for GetSubscriptionCapabilitiesResponseValue200ApplicationJsonPropertyData
{
...
impl GetSubscriptionCapabilitiesResponseValue200ApplicationJsonPropertyData {
