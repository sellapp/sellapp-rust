...
#[serde(remote = "Self")]
pub struct GetOrderSLineItemResponseValue200ApplicationJsonPropertyDataPropertyPromotion {
    pub phase_id: i64,
...
impl Serialize for GetOrderSLineItemResponseValue200ApplicationJsonPropertyDataPropertyPromotion {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for GetOrderSLineItemResponseValue200ApplicationJsonPropertyDataPropertyPromotion
{
...
impl GetOrderSLineItemResponseValue200ApplicationJsonPropertyDataPropertyPromotion {
