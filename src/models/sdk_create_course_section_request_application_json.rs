...
#[serde(remote = "Self")]
pub struct SdkCreateCourseSectionRequestApplicationJson {
    pub title: String,
    #[serde(
...
impl Serialize for SdkCreateCourseSectionRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateCourseSectionRequestApplicationJson {
...
impl SdkCreateCourseSectionRequestApplicationJson {
    ...
    pub fn validate_request(&self) -> Result<(), crate::error::Error> {
        ...
        crate::runtime_schema::model(&value, "SdkCreateCourseSectionRequestApplicationJson", true)
    }
}
