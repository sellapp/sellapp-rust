...
#[non_exhaustive]
pub enum SdkUpdateCouponRequestApplicationJsonType {
    Percentage,
    Amount,
...
impl SdkUpdateCouponRequestApplicationJsonType {
...
impl fmt::Display for SdkUpdateCouponRequestApplicationJsonType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkUpdateCouponRequestApplicationJsonType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkUpdateCouponRequestApplicationJsonType {
...
impl From<String> for SdkUpdateCouponRequestApplicationJsonType {
...
impl From<&str> for SdkUpdateCouponRequestApplicationJsonType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkUpdateCouponRequestApplicationJsonType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkUpdateCouponRequestApplicationJsonType {
