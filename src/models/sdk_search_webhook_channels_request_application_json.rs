...
#[serde(remote = "Self")]
pub struct SdkSearchWebhookChannelsRequestApplicationJson {
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub search: Option<SearchWebhookChannelsRequestApplicationJsonPropertySearch>,
...
impl Serialize for SdkSearchWebhookChannelsRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkSearchWebhookChannelsRequestApplicationJson {
...
impl SdkSearchWebhookChannelsRequestApplicationJson {
