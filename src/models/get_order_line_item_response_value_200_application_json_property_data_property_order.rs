...
#[serde(remote = "Self")]
pub struct GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertyOrder {
    pub id: i64,
...
impl Serialize for GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertyOrder {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertyOrder
{
...
impl GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertyOrder {
