...
#[serde(remote = "Self")]
pub struct SdkCreateSectionResponseValue201ApplicationJson {
    pub data: CreateSectionResponseValue201ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkCreateSectionResponseValue201ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateSectionResponseValue201ApplicationJson {
...
impl SdkCreateSectionResponseValue201ApplicationJson {
