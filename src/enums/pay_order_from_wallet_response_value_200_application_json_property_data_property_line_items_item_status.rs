...
#[non_exhaustive]
pub enum PayOrderFromWalletResponseValue200ApplicationJsonPropertyDataPropertyLineItemsItemStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl PayOrderFromWalletResponseValue200ApplicationJsonPropertyDataPropertyLineItemsItemStatus {
...
impl fmt::Display
    for PayOrderFromWalletResponseValue200ApplicationJsonPropertyDataPropertyLineItemsItemStatus
{
