...
#[serde(remote = "Self")]
pub struct GetInvoiceResponseValue200ApplicationJsonPropertyDataPropertyWebhooksItem {
    pub url: String,
...
impl Serialize for GetInvoiceResponseValue200ApplicationJsonPropertyDataPropertyWebhooksItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for GetInvoiceResponseValue200ApplicationJsonPropertyDataPropertyWebhooksItem
{
...
impl GetInvoiceResponseValue200ApplicationJsonPropertyDataPropertyWebhooksItem {
