...
#[serde(remote = "Self")]
pub struct ReplaceProductVariantWithPutRequestApplicationJsonPropertyOtherSettings {
...
impl Serialize for ReplaceProductVariantWithPutRequestApplicationJsonPropertyOtherSettings {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ReplaceProductVariantWithPutRequestApplicationJsonPropertyOtherSettings
{
...
impl ReplaceProductVariantWithPutRequestApplicationJsonPropertyOtherSettings {
