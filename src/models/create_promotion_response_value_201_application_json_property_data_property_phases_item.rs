...
#[serde(remote = "Self")]
pub struct CreatePromotionResponseValue201ApplicationJsonPropertyDataPropertyPhasesItem {
    pub id: i64,
...
impl Serialize for CreatePromotionResponseValue201ApplicationJsonPropertyDataPropertyPhasesItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for CreatePromotionResponseValue201ApplicationJsonPropertyDataPropertyPhasesItem
{
...
impl CreatePromotionResponseValue201ApplicationJsonPropertyDataPropertyPhasesItem {
