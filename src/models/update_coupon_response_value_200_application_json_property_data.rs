...
#[serde(remote = "Self")]
pub struct UpdateCouponResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: UpdateCouponResponseValue200ApplicationJsonPropertyDataType,
    pub discount: String,
...
impl Serialize for UpdateCouponResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for UpdateCouponResponseValue200ApplicationJsonPropertyData {
...
impl UpdateCouponResponseValue200ApplicationJsonPropertyData {
