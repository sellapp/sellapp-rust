...
#[serde(remote = "Self")]
pub struct SdkV2ReplaceFeedbackResponseValue200ApplicationJson {
    pub data: V2ReplaceFeedbackResponseValue200ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkV2ReplaceFeedbackResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkV2ReplaceFeedbackResponseValue200ApplicationJson {
...
impl SdkV2ReplaceFeedbackResponseValue200ApplicationJson {
