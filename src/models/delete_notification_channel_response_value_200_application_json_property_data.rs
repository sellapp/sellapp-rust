...
#[serde(remote = "Self")]
pub struct DeleteNotificationChannelResponseValue200ApplicationJsonPropertyData {
    ...
    pub id: String,
    #[serde(rename = "type")]
    pub type_: DeleteNotificationChannelResponseValue200ApplicationJsonPropertyDataType,
    #[serde(
...
impl Serialize for DeleteNotificationChannelResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for DeleteNotificationChannelResponseValue200ApplicationJsonPropertyData
{
...
impl DeleteNotificationChannelResponseValue200ApplicationJsonPropertyData {
