...
#[serde(remote = "Self")]
pub struct V2DeleteCouponResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: V2DeleteCouponResponseValue200ApplicationJsonPropertyDataType,
    pub discount: String,
...
impl Serialize for V2DeleteCouponResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2DeleteCouponResponseValue200ApplicationJsonPropertyData {
...
impl V2DeleteCouponResponseValue200ApplicationJsonPropertyData {
