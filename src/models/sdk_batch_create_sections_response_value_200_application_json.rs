...
#[serde(remote = "Self")]
pub struct SdkBatchCreateSectionsResponseValue200ApplicationJson {
    pub data: Vec<BatchCreateSectionsResponseValue200ApplicationJsonPropertyDataItem>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkBatchCreateSectionsResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkBatchCreateSectionsResponseValue200ApplicationJson {
...
impl SdkBatchCreateSectionsResponseValue200ApplicationJson {
