...
#[serde(remote = "Self")]
pub struct V2BatchCreateSectionsRequestApplicationJsonPropertyResourcesItem {
    pub title: String,
    pub hidden: bool,
...
impl Serialize for V2BatchCreateSectionsRequestApplicationJsonPropertyResourcesItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2BatchCreateSectionsRequestApplicationJsonPropertyResourcesItem {
...
impl V2BatchCreateSectionsRequestApplicationJsonPropertyResourcesItem {
