...
#[serde(remote = "Self")]
pub struct GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertySubscription {
    pub id: i64,
...
impl Serialize for GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertySubscription {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertySubscription
{
...
impl GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertySubscription {
