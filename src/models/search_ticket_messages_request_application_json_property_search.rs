...
#[serde(remote = "Self")]
pub struct SearchTicketMessagesRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchTicketMessagesRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchTicketMessagesRequestApplicationJsonPropertySearch {
...
impl SearchTicketMessagesRequestApplicationJsonPropertySearch {
