...
#[serde(remote = "Self")]
pub struct SdkIssueReplacementForCompletedInvoiceRequestApplicationJson {
...
impl Serialize for SdkIssueReplacementForCompletedInvoiceRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkIssueReplacementForCompletedInvoiceRequestApplicationJson {
...
impl SdkIssueReplacementForCompletedInvoiceRequestApplicationJson {
