...
#[serde(remote = "Self")]
pub struct CreateCouponResponseValue201ApplicationJsonPropertyData {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: CreateCouponResponseValue201ApplicationJsonPropertyDataType,
    pub discount: String,
...
impl Serialize for CreateCouponResponseValue201ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateCouponResponseValue201ApplicationJsonPropertyData {
...
impl CreateCouponResponseValue201ApplicationJsonPropertyData {
