...
#[serde(remote = "Self")]
pub struct GetAppointmentResponseValue200ApplicationJsonPropertyDataPropertyProduct {
    #[serde(
...
impl Serialize for GetAppointmentResponseValue200ApplicationJsonPropertyDataPropertyProduct {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for GetAppointmentResponseValue200ApplicationJsonPropertyDataPropertyProduct
{
...
impl GetAppointmentResponseValue200ApplicationJsonPropertyDataPropertyProduct {
