...
#[serde(remote = "Self")]
pub struct ListPendingAffiliateInvitationsResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
    pub email: String,
    pub status: String,
    pub invited_at: Option<String>,
    pub application_submitted_at: Option<String>,
    pub created_at: Option<String>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for ListPendingAffiliateInvitationsResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ListPendingAffiliateInvitationsResponseValue200ApplicationJsonPropertyDataItem
{
...
impl ListPendingAffiliateInvitationsResponseValue200ApplicationJsonPropertyDataItem {
