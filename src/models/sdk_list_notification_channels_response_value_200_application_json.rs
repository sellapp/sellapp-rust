...
#[serde(remote = "Self")]
pub struct SdkListNotificationChannelsResponseValue200ApplicationJson {
    pub data: Vec<ListNotificationChannelsResponseValue200ApplicationJsonPropertyDataItem>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkListNotificationChannelsResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkListNotificationChannelsResponseValue200ApplicationJson {
...
impl SdkListNotificationChannelsResponseValue200ApplicationJson {
