...
#[serde(remote = "Self")]
pub struct ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue2 {
...
impl Serialize for ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue2 {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue2
{
...
impl ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue2 {
