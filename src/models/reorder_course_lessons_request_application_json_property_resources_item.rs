...
#[serde(remote = "Self")]
pub struct ReorderCourseLessonsRequestApplicationJsonPropertyResourcesItem {
    pub id: i64,
    pub section_id: i64,
...
impl Serialize for ReorderCourseLessonsRequestApplicationJsonPropertyResourcesItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ReorderCourseLessonsRequestApplicationJsonPropertyResourcesItem {
...
impl ReorderCourseLessonsRequestApplicationJsonPropertyResourcesItem {
