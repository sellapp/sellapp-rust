...
#[non_exhaustive]
pub enum GetOrderSLineItemResponseValue200ApplicationJsonPropertyDataPropertyFulfillmentTypes {
    Downloadable,
    Text,
    Dynamic,
    Manual,
...
impl GetOrderSLineItemResponseValue200ApplicationJsonPropertyDataPropertyFulfillmentTypes {
...
impl fmt::Display
    for GetOrderSLineItemResponseValue200ApplicationJsonPropertyDataPropertyFulfillmentTypes
{
