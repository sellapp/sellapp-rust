...
#[serde(remote = "Self")]
pub struct SdkCreateVariantDeliverableFolderRequestApplicationJson {
    pub name: String,
    #[serde(
...
impl Serialize for SdkCreateVariantDeliverableFolderRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateVariantDeliverableFolderRequestApplicationJson {
...
impl SdkCreateVariantDeliverableFolderRequestApplicationJson {
