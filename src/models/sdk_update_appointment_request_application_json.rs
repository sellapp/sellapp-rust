...
#[serde(remote = "Self")]
pub struct SdkUpdateAppointmentRequestApplicationJson {
...
impl Serialize for SdkUpdateAppointmentRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkUpdateAppointmentRequestApplicationJson {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let mut value = serde_json::Value::deserialize(deserializer)?;
        crate::runtime_schema::model(&value, "SdkUpdateAppointmentRequestApplicationJson", false)
...
impl SdkUpdateAppointmentRequestApplicationJson {
    ...
    pub fn validate_request(&self) -> Result<(), crate::error::Error> {
        ...
        crate::runtime_schema::model(&value, "SdkUpdateAppointmentRequestApplicationJson", true)
    }
}
