...
#[non_exhaustive]
pub enum ReplaceVariantDeliverableConfigurationResponseValue200ApplicationJsonPropertyDataTypes {
    Downloadable,
    Text,
    Dynamic,
    Manual,
...
impl ReplaceVariantDeliverableConfigurationResponseValue200ApplicationJsonPropertyDataTypes {
...
impl fmt::Display
    for ReplaceVariantDeliverableConfigurationResponseValue200ApplicationJsonPropertyDataTypes
{
