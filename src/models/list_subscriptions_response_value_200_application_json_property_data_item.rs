...
#[serde(remote = "Self")]
pub struct ListSubscriptionsResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
    pub status: String,
    #[serde(
    ...
    pub customer: ListSubscriptionsResponseValue200ApplicationJsonPropertyDataItemPropertyCustomer,
...
impl Serialize for ListSubscriptionsResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ListSubscriptionsResponseValue200ApplicationJsonPropertyDataItem {
...
impl ListSubscriptionsResponseValue200ApplicationJsonPropertyDataItem {
