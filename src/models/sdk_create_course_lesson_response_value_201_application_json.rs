...
#[serde(remote = "Self")]
pub struct SdkCreateCourseLessonResponseValue201ApplicationJson {
    pub data: CreateCourseLessonResponseValue201ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkCreateCourseLessonResponseValue201ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateCourseLessonResponseValue201ApplicationJson {
...
impl SdkCreateCourseLessonResponseValue201ApplicationJson {
