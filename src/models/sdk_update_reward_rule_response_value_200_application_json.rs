...
#[serde(remote = "Self")]
pub struct SdkUpdateRewardRuleResponseValue200ApplicationJson {
    pub data: UpdateRewardRuleResponseValue200ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkUpdateRewardRuleResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkUpdateRewardRuleResponseValue200ApplicationJson {
...
impl SdkUpdateRewardRuleResponseValue200ApplicationJson {
