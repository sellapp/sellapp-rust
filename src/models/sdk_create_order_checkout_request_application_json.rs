...
#[serde(remote = "Self")]
pub struct SdkCreateOrderCheckoutRequestApplicationJson {
...
impl Serialize for SdkCreateOrderCheckoutRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateOrderCheckoutRequestApplicationJson {
...
impl SdkCreateOrderCheckoutRequestApplicationJson {
    ...
    pub fn validate_request(&self) -> Result<(), crate::error::Error> {
        ...
        crate::runtime_schema::model(&value, "SdkCreateOrderCheckoutRequestApplicationJson", true)
    }
}
