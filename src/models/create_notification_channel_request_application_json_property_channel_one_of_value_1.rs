...
#[serde(remote = "Self")]
pub struct CreateNotificationChannelRequestApplicationJsonPropertyChannelOneOfValue1 {
    #[serde(rename = "type")]
    pub type_: String,
    pub email: String,
...
impl Serialize for CreateNotificationChannelRequestApplicationJsonPropertyChannelOneOfValue1 {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for CreateNotificationChannelRequestApplicationJsonPropertyChannelOneOfValue1
{
...
impl CreateNotificationChannelRequestApplicationJsonPropertyChannelOneOfValue1 {
