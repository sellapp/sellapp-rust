...
#[serde(remote = "Self")]
pub struct CreateCheckoutSessionResponseValue201ApplicationJsonPropertyInvoicePropertyWebhooksItem {
    pub url: String,
...
impl Serialize
    for CreateCheckoutSessionResponseValue201ApplicationJsonPropertyInvoicePropertyWebhooksItem
{
    ...
    for CreateCheckoutSessionResponseValue201ApplicationJsonPropertyInvoicePropertyWebhooksItem
{
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        crate::runtime_schema::model(&value, "CreateCheckoutSessionResponseValue201ApplicationJsonPropertyInvoicePropertyWebhooksItem", false).map_err(serde::de::Error::custom)?;
...
impl CreateCheckoutSessionResponseValue201ApplicationJsonPropertyInvoicePropertyWebhooksItem {
