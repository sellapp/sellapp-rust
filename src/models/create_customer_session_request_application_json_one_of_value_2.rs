...
#[serde(remote = "Self")]
pub struct CreateCustomerSessionRequestApplicationJsonOneOfValue2 {
    pub external_customer_id: String,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for CreateCustomerSessionRequestApplicationJsonOneOfValue2 {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateCustomerSessionRequestApplicationJsonOneOfValue2 {
...
impl CreateCustomerSessionRequestApplicationJsonOneOfValue2 {
