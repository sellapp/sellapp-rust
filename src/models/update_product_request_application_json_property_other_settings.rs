...
#[serde(remote = "Self")]
pub struct UpdateProductRequestApplicationJsonPropertyOtherSettings {
...
impl Serialize for UpdateProductRequestApplicationJsonPropertyOtherSettings {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for UpdateProductRequestApplicationJsonPropertyOtherSettings {
...
impl UpdateProductRequestApplicationJsonPropertyOtherSettings {
