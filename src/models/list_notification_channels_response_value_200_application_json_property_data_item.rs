...
#[serde(remote = "Self")]
pub struct ListNotificationChannelsResponseValue200ApplicationJsonPropertyDataItem {
    ...
    pub id: String,
    #[serde(rename = "type")]
    pub type_: ListNotificationChannelsResponseValue200ApplicationJsonPropertyDataItemType,
    #[serde(
...
impl Serialize for ListNotificationChannelsResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ListNotificationChannelsResponseValue200ApplicationJsonPropertyDataItem
{
...
impl ListNotificationChannelsResponseValue200ApplicationJsonPropertyDataItem {
