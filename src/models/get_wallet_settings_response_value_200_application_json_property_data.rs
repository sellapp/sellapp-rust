...
#[serde(remote = "Self")]
pub struct GetWalletSettingsResponseValue200ApplicationJsonPropertyData {
    pub enabled: bool,
...
impl Serialize for GetWalletSettingsResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for GetWalletSettingsResponseValue200ApplicationJsonPropertyData {
...
impl GetWalletSettingsResponseValue200ApplicationJsonPropertyData {
