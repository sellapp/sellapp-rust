...
#[serde(remote = "Self")]
pub struct SearchHighlightsRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchHighlightsRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchHighlightsRequestApplicationJsonPropertySearch {
...
impl SearchHighlightsRequestApplicationJsonPropertySearch {
