...
#[serde(remote = "Self")]
pub struct ResumeCustomerSubscriptionResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub status: String,
    #[serde(
...
impl Serialize for ResumeCustomerSubscriptionResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ResumeCustomerSubscriptionResponseValue200ApplicationJsonPropertyData
{
...
impl ResumeCustomerSubscriptionResponseValue200ApplicationJsonPropertyData {
