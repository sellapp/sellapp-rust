...
#[serde(remote = "Self")]
pub struct SdkCreateCheckoutSessionResponseValue201ApplicationJson {
    pub message: String,
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub payment_url: Option<String>,
    pub invoice: CreateCheckoutSessionResponseValue201ApplicationJsonPropertyInvoice,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkCreateCheckoutSessionResponseValue201ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateCheckoutSessionResponseValue201ApplicationJson {
...
impl SdkCreateCheckoutSessionResponseValue201ApplicationJson {
