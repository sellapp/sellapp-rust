...
#[serde(remote = "Self")]
pub struct SdkCreateProductVariantResponseValue201ApplicationJson {
    pub data: CreateProductVariantResponseValue201ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkCreateProductVariantResponseValue201ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateProductVariantResponseValue201ApplicationJson {
...
impl SdkCreateProductVariantResponseValue201ApplicationJson {
