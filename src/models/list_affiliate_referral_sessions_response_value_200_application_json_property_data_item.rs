...
#[serde(remote = "Self")]
pub struct ListAffiliateReferralSessionsResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
...
impl Serialize for ListAffiliateReferralSessionsResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ListAffiliateReferralSessionsResponseValue200ApplicationJsonPropertyDataItem
{
...
impl ListAffiliateReferralSessionsResponseValue200ApplicationJsonPropertyDataItem {
