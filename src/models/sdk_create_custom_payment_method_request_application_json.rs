...
#[serde(remote = "Self")]
pub struct SdkCreateCustomPaymentMethodRequestApplicationJson {
    #[serde(rename = "type")]
    pub type_: SdkCreateCustomPaymentMethodRequestApplicationJsonType,
    pub name: String,
    #[serde(
    ...
    pub modifier: Option<Option<CreateCustomPaymentMethodRequestApplicationJsonPropertyModifier>>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkCreateCustomPaymentMethodRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateCustomPaymentMethodRequestApplicationJson {
...
impl SdkCreateCustomPaymentMethodRequestApplicationJson {
