...
#[serde(remote = "Self")]
pub struct SdkGetFeedbackResponseValue200ApplicationJson {
    pub data: GetFeedbackResponseValue200ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkGetFeedbackResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkGetFeedbackResponseValue200ApplicationJson {
...
impl SdkGetFeedbackResponseValue200ApplicationJson {
