...
#[serde(remote = "Self")]
pub struct ReplaceWalletSettingsResponseValue200ApplicationJsonPropertyData {
    pub enabled: bool,
...
impl Serialize for ReplaceWalletSettingsResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ReplaceWalletSettingsResponseValue200ApplicationJsonPropertyData {
...
impl ReplaceWalletSettingsResponseValue200ApplicationJsonPropertyData {
