...
#[serde(remote = "Self")]
pub struct GetStoreResponseValue200ApplicationJsonPropertyData {
    pub id: String,
    pub slug: String,
    pub name: String,
...
impl Serialize for GetStoreResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for GetStoreResponseValue200ApplicationJsonPropertyData {
...
impl GetStoreResponseValue200ApplicationJsonPropertyData {
