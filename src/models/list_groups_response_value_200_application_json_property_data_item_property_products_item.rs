...
#[serde(remote = "Self")]
pub struct ListGroupsResponseValue200ApplicationJsonPropertyDataItemPropertyProductsItem {
...
impl Serialize for ListGroupsResponseValue200ApplicationJsonPropertyDataItemPropertyProductsItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ListGroupsResponseValue200ApplicationJsonPropertyDataItemPropertyProductsItem
{
...
impl ListGroupsResponseValue200ApplicationJsonPropertyDataItemPropertyProductsItem {
