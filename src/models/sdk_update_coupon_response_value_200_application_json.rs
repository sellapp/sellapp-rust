...
#[serde(remote = "Self")]
pub struct SdkUpdateCouponResponseValue200ApplicationJson {
    pub data: UpdateCouponResponseValue200ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkUpdateCouponResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkUpdateCouponResponseValue200ApplicationJson {
...
impl SdkUpdateCouponResponseValue200ApplicationJson {
