...
#[serde(remote = "Self")]
pub struct MarkPendingInvoiceVoidedResponseValue200ApplicationJsonPropertyWebhooksItem {
    pub url: String,
...
impl Serialize for MarkPendingInvoiceVoidedResponseValue200ApplicationJsonPropertyWebhooksItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for MarkPendingInvoiceVoidedResponseValue200ApplicationJsonPropertyWebhooksItem
{
...
impl MarkPendingInvoiceVoidedResponseValue200ApplicationJsonPropertyWebhooksItem {
