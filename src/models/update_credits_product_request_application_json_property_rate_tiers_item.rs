...
#[serde(remote = "Self")]
pub struct UpdateCreditsProductRequestApplicationJsonPropertyRateTiersItem {
...
impl Serialize for UpdateCreditsProductRequestApplicationJsonPropertyRateTiersItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for UpdateCreditsProductRequestApplicationJsonPropertyRateTiersItem {
...
impl UpdateCreditsProductRequestApplicationJsonPropertyRateTiersItem {
