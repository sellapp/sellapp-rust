...
#[serde(remote = "Self")]
pub struct SearchCouponsRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchCouponsRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchCouponsRequestApplicationJsonPropertySearch {
...
impl SearchCouponsRequestApplicationJsonPropertySearch {
