...
#[serde(remote = "Self")]
pub struct SdkListPromotionPhasesResponseValue200ApplicationJson {
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub data: Option<Vec<ListPromotionPhasesResponseValue200ApplicationJsonPropertyDataItem>>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkListPromotionPhasesResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkListPromotionPhasesResponseValue200ApplicationJson {
...
impl SdkListPromotionPhasesResponseValue200ApplicationJson {
