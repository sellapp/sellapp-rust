...
#[serde(remote = "Self")]
pub struct ReplaceProductVariantWithPutRequestApplicationJsonPropertyBulkDiscountItem {
...
impl Serialize for ReplaceProductVariantWithPutRequestApplicationJsonPropertyBulkDiscountItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ReplaceProductVariantWithPutRequestApplicationJsonPropertyBulkDiscountItem
{
...
impl ReplaceProductVariantWithPutRequestApplicationJsonPropertyBulkDiscountItem {
