...
#[serde(remote = "Self")]
pub struct CancelSubscriptionResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
...
impl Serialize for CancelSubscriptionResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CancelSubscriptionResponseValue200ApplicationJsonPropertyData {
...
impl CancelSubscriptionResponseValue200ApplicationJsonPropertyData {
