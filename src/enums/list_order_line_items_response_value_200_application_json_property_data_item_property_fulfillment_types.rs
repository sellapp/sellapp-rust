...
#[non_exhaustive]
pub enum ListOrderLineItemsResponseValue200ApplicationJsonPropertyDataItemPropertyFulfillmentTypes {
    Downloadable,
    Text,
    Dynamic,
    Manual,
...
impl ListOrderLineItemsResponseValue200ApplicationJsonPropertyDataItemPropertyFulfillmentTypes {
...
impl fmt::Display
    for ListOrderLineItemsResponseValue200ApplicationJsonPropertyDataItemPropertyFulfillmentTypes
{
