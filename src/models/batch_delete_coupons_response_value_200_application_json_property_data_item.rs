...
#[serde(remote = "Self")]
pub struct BatchDeleteCouponsResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: BatchDeleteCouponsResponseValue200ApplicationJsonPropertyDataItemType,
    pub discount: String,
...
impl Serialize for BatchDeleteCouponsResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for BatchDeleteCouponsResponseValue200ApplicationJsonPropertyDataItem {
...
impl BatchDeleteCouponsResponseValue200ApplicationJsonPropertyDataItem {
