...
#[non_exhaustive]
pub enum SdkUpdateCourseRequestApplicationJsonLevel {
    AllLevels,
    Beginner,
    Intermediate,
    Advanced,
...
impl SdkUpdateCourseRequestApplicationJsonLevel {
...
impl fmt::Display for SdkUpdateCourseRequestApplicationJsonLevel {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkUpdateCourseRequestApplicationJsonLevel {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkUpdateCourseRequestApplicationJsonLevel {
...
impl From<String> for SdkUpdateCourseRequestApplicationJsonLevel {
...
impl From<&str> for SdkUpdateCourseRequestApplicationJsonLevel {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkUpdateCourseRequestApplicationJsonLevel {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkUpdateCourseRequestApplicationJsonLevel {
