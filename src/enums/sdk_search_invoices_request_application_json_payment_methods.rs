...
#[non_exhaustive]
pub enum SdkSearchInvoicesRequestApplicationJsonPaymentMethods {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl SdkSearchInvoicesRequestApplicationJsonPaymentMethods {
...
impl fmt::Display for SdkSearchInvoicesRequestApplicationJsonPaymentMethods {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkSearchInvoicesRequestApplicationJsonPaymentMethods {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkSearchInvoicesRequestApplicationJsonPaymentMethods {
...
impl From<String> for SdkSearchInvoicesRequestApplicationJsonPaymentMethods {
...
impl From<&str> for SdkSearchInvoicesRequestApplicationJsonPaymentMethods {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkSearchInvoicesRequestApplicationJsonPaymentMethods {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkSearchInvoicesRequestApplicationJsonPaymentMethods {
