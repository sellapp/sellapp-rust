...
#[serde(remote = "Self")]
pub struct SdkReplaceCreditsProductRequestApplicationJson {
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub quantity_increment: Option<i64>,
    #[serde(
        skip_serializing_if = "Option::is_none",
        default,
        deserialize_with = "crate::runtime_schema::present_nullable"
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub payment_methods: Option<Vec<SdkReplaceCreditsProductRequestApplicationJsonPaymentMethods>>,
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub rate_tiers: Option<Vec<ReplaceCreditsProductRequestApplicationJsonPropertyRateTiersItem>>,
    #[serde(skip_serializing_if = "Option::is_none", default)]
...
impl Serialize for SdkReplaceCreditsProductRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkReplaceCreditsProductRequestApplicationJson {
...
impl SdkReplaceCreditsProductRequestApplicationJson {
