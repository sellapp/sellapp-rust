...
#[serde(remote = "Self")]
pub struct CreateProductRequestApplicationJsonPropertyBundleItemsItem {
...
impl Serialize for CreateProductRequestApplicationJsonPropertyBundleItemsItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateProductRequestApplicationJsonPropertyBundleItemsItem {
...
impl CreateProductRequestApplicationJsonPropertyBundleItemsItem {
