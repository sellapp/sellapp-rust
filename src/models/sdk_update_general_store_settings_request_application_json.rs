...
#[serde(remote = "Self")]
pub struct SdkUpdateGeneralStoreSettingsRequestApplicationJson {
...
impl Serialize for SdkUpdateGeneralStoreSettingsRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkUpdateGeneralStoreSettingsRequestApplicationJson {
...
impl SdkUpdateGeneralStoreSettingsRequestApplicationJson {
