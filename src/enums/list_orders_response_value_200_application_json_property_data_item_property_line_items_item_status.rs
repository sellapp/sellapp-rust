...
#[non_exhaustive]
pub enum ListOrdersResponseValue200ApplicationJsonPropertyDataItemPropertyLineItemsItemStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl ListOrdersResponseValue200ApplicationJsonPropertyDataItemPropertyLineItemsItemStatus {
...
impl fmt::Display
    for ListOrdersResponseValue200ApplicationJsonPropertyDataItemPropertyLineItemsItemStatus
{
