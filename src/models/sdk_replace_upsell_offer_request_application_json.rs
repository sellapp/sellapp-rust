...
#[serde(remote = "Self")]
pub struct SdkReplaceUpsellOfferRequestApplicationJson {
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub items: Option<Vec<ReplaceUpsellOfferRequestApplicationJsonPropertyItemsItem>>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkReplaceUpsellOfferRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkReplaceUpsellOfferRequestApplicationJson {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let mut value = serde_json::Value::deserialize(deserializer)?;
        crate::runtime_schema::model(&value, "SdkReplaceUpsellOfferRequestApplicationJson", false)
...
impl SdkReplaceUpsellOfferRequestApplicationJson {
    ...
    pub fn validate_request(&self) -> Result<(), crate::error::Error> {
        ...
        crate::runtime_schema::model(&value, "SdkReplaceUpsellOfferRequestApplicationJson", true)
    }
}
