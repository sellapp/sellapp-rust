...
#[non_exhaustive]
pub enum CreateInvoiceRefundResponseValue200ApplicationJsonPropertyDataPropertyRefundStatus {
    Pending,
    Effective,
    Failed,
    Cancelled,
...
impl CreateInvoiceRefundResponseValue200ApplicationJsonPropertyDataPropertyRefundStatus {
...
impl fmt::Display
    for CreateInvoiceRefundResponseValue200ApplicationJsonPropertyDataPropertyRefundStatus
{
