...
#[serde(remote = "Self")]
pub struct V2BatchCreateCouponsRequestApplicationJsonPropertyResourcesItem {
    pub code: String,
    #[serde(rename = "type")]
    pub type_: V2BatchCreateCouponsRequestApplicationJsonPropertyResourcesItemType,
...
impl Serialize for V2BatchCreateCouponsRequestApplicationJsonPropertyResourcesItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2BatchCreateCouponsRequestApplicationJsonPropertyResourcesItem {
...
impl V2BatchCreateCouponsRequestApplicationJsonPropertyResourcesItem {
