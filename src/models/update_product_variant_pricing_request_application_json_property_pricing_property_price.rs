...
#[serde(remote = "Self")]
pub struct UpdateProductVariantPricingRequestApplicationJsonPropertyPricingPropertyPrice {
...
impl Serialize for UpdateProductVariantPricingRequestApplicationJsonPropertyPricingPropertyPrice {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for UpdateProductVariantPricingRequestApplicationJsonPropertyPricingPropertyPrice
{
...
impl UpdateProductVariantPricingRequestApplicationJsonPropertyPricingPropertyPrice {
