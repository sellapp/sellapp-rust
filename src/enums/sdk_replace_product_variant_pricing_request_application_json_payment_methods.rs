...
#[non_exhaustive]
pub enum SdkReplaceProductVariantPricingRequestApplicationJsonPaymentMethods {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl SdkReplaceProductVariantPricingRequestApplicationJsonPaymentMethods {
...
impl fmt::Display for SdkReplaceProductVariantPricingRequestApplicationJsonPaymentMethods {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkReplaceProductVariantPricingRequestApplicationJsonPaymentMethods {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkReplaceProductVariantPricingRequestApplicationJsonPaymentMethods {
...
impl From<String> for SdkReplaceProductVariantPricingRequestApplicationJsonPaymentMethods {
...
impl From<&str> for SdkReplaceProductVariantPricingRequestApplicationJsonPaymentMethods {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkReplaceProductVariantPricingRequestApplicationJsonPaymentMethods {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkReplaceProductVariantPricingRequestApplicationJsonPaymentMethods {
