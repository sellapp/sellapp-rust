...
#[non_exhaustive]
pub enum RetryOrderFulfillmentResponseValue200ApplicationJsonPropertyDataPropertyLineItemsItemStatus
{
    Pending,
    Reversed,
    Partial,
...
impl RetryOrderFulfillmentResponseValue200ApplicationJsonPropertyDataPropertyLineItemsItemStatus {
...
impl fmt::Display
    for RetryOrderFulfillmentResponseValue200ApplicationJsonPropertyDataPropertyLineItemsItemStatus
{
