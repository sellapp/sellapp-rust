...
#[non_exhaustive]
pub enum UpdateProductVariantRequestApplicationJsonPropertyDeliverablePropertyDataParsingMode {
    Comma,
    NewLine,
    Space,
    Custom,
...
impl UpdateProductVariantRequestApplicationJsonPropertyDeliverablePropertyDataParsingMode {
...
impl fmt::Display
    for UpdateProductVariantRequestApplicationJsonPropertyDeliverablePropertyDataParsingMode
{
