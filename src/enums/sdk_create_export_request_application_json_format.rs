...
#[non_exhaustive]
pub enum SdkCreateExportRequestApplicationJsonFormat {
    Csv,
    Json,
...
impl SdkCreateExportRequestApplicationJsonFormat {
...
impl fmt::Display for SdkCreateExportRequestApplicationJsonFormat {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkCreateExportRequestApplicationJsonFormat {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkCreateExportRequestApplicationJsonFormat {
...
impl From<String> for SdkCreateExportRequestApplicationJsonFormat {
...
impl From<&str> for SdkCreateExportRequestApplicationJsonFormat {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkCreateExportRequestApplicationJsonFormat {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkCreateExportRequestApplicationJsonFormat {
