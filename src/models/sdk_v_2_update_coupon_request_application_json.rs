...
#[serde(remote = "Self")]
pub struct SdkV2UpdateCouponRequestApplicationJson {
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub code: Option<String>,
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub type_: Option<SdkV2UpdateCouponRequestApplicationJsonType>,
...
impl Serialize for SdkV2UpdateCouponRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkV2UpdateCouponRequestApplicationJson {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let mut value = serde_json::Value::deserialize(deserializer)?;
        crate::runtime_schema::model(&value, "SdkV2UpdateCouponRequestApplicationJson", false)
            .map_err(serde::de::Error::custom)?;
        crate::runtime_schema::retain_model_fields(
            &mut value,
            "SdkV2UpdateCouponRequestApplicationJson",
        );
        Self::deserialize(value).map_err(serde::de::Error::custom)
    }
}
impl SdkV2UpdateCouponRequestApplicationJson {
    ...
    pub fn validate_request(&self) -> Result<(), crate::error::Error> {
        ...
        crate::runtime_schema::model(&value, "SdkV2UpdateCouponRequestApplicationJson", true)
    }
}
