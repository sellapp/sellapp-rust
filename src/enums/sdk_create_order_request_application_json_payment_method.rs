...
#[non_exhaustive]
pub enum SdkCreateOrderRequestApplicationJsonPaymentMethod {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl SdkCreateOrderRequestApplicationJsonPaymentMethod {
...
impl fmt::Display for SdkCreateOrderRequestApplicationJsonPaymentMethod {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkCreateOrderRequestApplicationJsonPaymentMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkCreateOrderRequestApplicationJsonPaymentMethod {
...
impl From<String> for SdkCreateOrderRequestApplicationJsonPaymentMethod {
...
impl From<&str> for SdkCreateOrderRequestApplicationJsonPaymentMethod {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkCreateOrderRequestApplicationJsonPaymentMethod {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkCreateOrderRequestApplicationJsonPaymentMethod {
