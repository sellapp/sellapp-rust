...
#[serde(remote = "Self")]
pub struct CreateCheckoutSessionResponseValue200ApplicationJsonPropertyInvoicePropertyWebhooksItem {
    pub url: String,
...
impl Serialize
    for CreateCheckoutSessionResponseValue200ApplicationJsonPropertyInvoicePropertyWebhooksItem
{
    ...
    for CreateCheckoutSessionResponseValue200ApplicationJsonPropertyInvoicePropertyWebhooksItem
{
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        crate::runtime_schema::model(&value, "CreateCheckoutSessionResponseValue200ApplicationJsonPropertyInvoicePropertyWebhooksItem", false).map_err(serde::de::Error::custom)?;
...
impl CreateCheckoutSessionResponseValue200ApplicationJsonPropertyInvoicePropertyWebhooksItem {
