...
#[serde(remote = "Self")]
pub struct ExchangeOAuthTokenRequestApplicationXWwwFormUrlencodedOneOfValue2 {
...
impl Serialize for ExchangeOAuthTokenRequestApplicationXWwwFormUrlencodedOneOfValue2 {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ExchangeOAuthTokenRequestApplicationXWwwFormUrlencodedOneOfValue2 {
...
impl ExchangeOAuthTokenRequestApplicationXWwwFormUrlencodedOneOfValue2 {
