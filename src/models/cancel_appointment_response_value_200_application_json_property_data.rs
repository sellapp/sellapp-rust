...
#[serde(remote = "Self")]
pub struct CancelAppointmentResponseValue200ApplicationJsonPropertyData {
    pub id: String,
    pub product_id: i64,
    ...
    pub timezone: String,
    pub quantity: i64,
    pub status: CancelAppointmentResponseValue200ApplicationJsonPropertyDataStatus,
    ...
    pub product:
        Option<CancelAppointmentResponseValue200ApplicationJsonPropertyDataPropertyProduct>,
    pub variant:
        Option<CancelAppointmentResponseValue200ApplicationJsonPropertyDataPropertyVariant>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for CancelAppointmentResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CancelAppointmentResponseValue200ApplicationJsonPropertyData {
...
impl CancelAppointmentResponseValue200ApplicationJsonPropertyData {
