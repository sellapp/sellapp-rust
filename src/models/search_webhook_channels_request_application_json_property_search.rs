...
#[serde(remote = "Self")]
pub struct SearchWebhookChannelsRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchWebhookChannelsRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchWebhookChannelsRequestApplicationJsonPropertySearch {
...
impl SearchWebhookChannelsRequestApplicationJsonPropertySearch {
