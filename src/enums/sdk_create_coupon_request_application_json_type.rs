...
#[non_exhaustive]
pub enum SdkCreateCouponRequestApplicationJsonType {
    Percentage,
    Amount,
...
impl SdkCreateCouponRequestApplicationJsonType {
...
impl fmt::Display for SdkCreateCouponRequestApplicationJsonType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkCreateCouponRequestApplicationJsonType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkCreateCouponRequestApplicationJsonType {
...
impl From<String> for SdkCreateCouponRequestApplicationJsonType {
...
impl From<&str> for SdkCreateCouponRequestApplicationJsonType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkCreateCouponRequestApplicationJsonType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkCreateCouponRequestApplicationJsonType {
