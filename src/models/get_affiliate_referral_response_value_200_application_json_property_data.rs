...
#[serde(remote = "Self")]
pub struct GetAffiliateReferralResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    ...
    pub status: GetAffiliateReferralResponseValue200ApplicationJsonPropertyDataStatus,
    #[serde(skip_serializing_if = "Option::is_none", default)]
...
impl Serialize for GetAffiliateReferralResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for GetAffiliateReferralResponseValue200ApplicationJsonPropertyData {
...
impl GetAffiliateReferralResponseValue200ApplicationJsonPropertyData {
