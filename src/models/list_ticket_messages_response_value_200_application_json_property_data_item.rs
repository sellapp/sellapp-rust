...
#[serde(remote = "Self")]
pub struct ListTicketMessagesResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
    pub author: String,
...
impl Serialize for ListTicketMessagesResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ListTicketMessagesResponseValue200ApplicationJsonPropertyDataItem {
...
impl ListTicketMessagesResponseValue200ApplicationJsonPropertyDataItem {
