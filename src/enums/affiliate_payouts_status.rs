...
#[non_exhaustive]
pub enum AffiliatePayoutsStatus {
    Due,
    Paid,
...
impl fmt::Display for AffiliatePayoutsStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for AffiliatePayoutsStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for AffiliatePayoutsStatus {
...
impl From<String> for AffiliatePayoutsStatus {
...
impl From<&str> for AffiliatePayoutsStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for AffiliatePayoutsStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for AffiliatePayoutsStatus {
