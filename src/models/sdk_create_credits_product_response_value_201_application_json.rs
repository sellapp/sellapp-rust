...
#[serde(remote = "Self")]
pub struct SdkCreateCreditsProductResponseValue201ApplicationJson {
    pub data: CreateCreditsProductResponseValue201ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkCreateCreditsProductResponseValue201ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateCreditsProductResponseValue201ApplicationJson {
...
impl SdkCreateCreditsProductResponseValue201ApplicationJson {
