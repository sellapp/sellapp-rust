...
#[serde(remote = "Self")]
pub struct SearchProductsRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchProductsRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchProductsRequestApplicationJsonPropertySearch {
...
impl SearchProductsRequestApplicationJsonPropertySearch {
