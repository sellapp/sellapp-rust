...
#[serde(remote = "Self")]
pub struct GetCourseResponseValue200ApplicationJsonPropertyDataPropertyPromoVideo {
...
impl Serialize for GetCourseResponseValue200ApplicationJsonPropertyDataPropertyPromoVideo {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for GetCourseResponseValue200ApplicationJsonPropertyDataPropertyPromoVideo
{
...
impl GetCourseResponseValue200ApplicationJsonPropertyDataPropertyPromoVideo {
