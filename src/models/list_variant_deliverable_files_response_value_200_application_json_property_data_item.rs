...
#[serde(remote = "Self")]
pub struct ListVariantDeliverableFilesResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
    #[serde(
...
impl Serialize for ListVariantDeliverableFilesResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ListVariantDeliverableFilesResponseValue200ApplicationJsonPropertyDataItem
{
...
impl ListVariantDeliverableFilesResponseValue200ApplicationJsonPropertyDataItem {
