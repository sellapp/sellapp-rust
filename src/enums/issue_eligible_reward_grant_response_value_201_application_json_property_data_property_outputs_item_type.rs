...
#[non_exhaustive]
pub enum IssueEligibleRewardGrantResponseValue201ApplicationJsonPropertyDataPropertyOutputsItemType
{
    WalletCredit,
    Coupon,
    Badge,
...
impl IssueEligibleRewardGrantResponseValue201ApplicationJsonPropertyDataPropertyOutputsItemType {
...
impl fmt::Display
    for IssueEligibleRewardGrantResponseValue201ApplicationJsonPropertyDataPropertyOutputsItemType
{
