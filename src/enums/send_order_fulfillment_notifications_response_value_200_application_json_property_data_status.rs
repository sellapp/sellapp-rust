...
#[non_exhaustive]
pub enum SendOrderFulfillmentNotificationsResponseValue200ApplicationJsonPropertyDataStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl SendOrderFulfillmentNotificationsResponseValue200ApplicationJsonPropertyDataStatus {
...
impl fmt::Display
    for SendOrderFulfillmentNotificationsResponseValue200ApplicationJsonPropertyDataStatus
{
