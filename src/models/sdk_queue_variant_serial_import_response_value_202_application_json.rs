...
#[serde(remote = "Self")]
pub struct SdkQueueVariantSerialImportResponseValue202ApplicationJson {
    pub data: QueueVariantSerialImportResponseValue202ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkQueueVariantSerialImportResponseValue202ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkQueueVariantSerialImportResponseValue202ApplicationJson {
...
impl SdkQueueVariantSerialImportResponseValue202ApplicationJson {
