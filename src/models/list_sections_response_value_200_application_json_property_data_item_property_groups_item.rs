...
#[serde(remote = "Self")]
pub struct ListSectionsResponseValue200ApplicationJsonPropertyDataItemPropertyGroupsItem {
    pub id: i64,
    pub title: String,
...
impl Serialize for ListSectionsResponseValue200ApplicationJsonPropertyDataItemPropertyGroupsItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ListSectionsResponseValue200ApplicationJsonPropertyDataItemPropertyGroupsItem
{
...
impl ListSectionsResponseValue200ApplicationJsonPropertyDataItemPropertyGroupsItem {
