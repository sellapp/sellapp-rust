...
#[serde(remote = "Self")]
pub struct SdkReplaceHighlightMediaMetadataRequestApplicationJson {
...
impl Serialize for SdkReplaceHighlightMediaMetadataRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkReplaceHighlightMediaMetadataRequestApplicationJson {
...
impl SdkReplaceHighlightMediaMetadataRequestApplicationJson {
