...
#[serde(remote = "Self")]
pub struct CreateCreditsProductResponseValue201ApplicationJsonPropertyData {
    pub id: i64,
    pub store_id: i64,
    pub title: String,
    pub slug: String,
...
impl Serialize for CreateCreditsProductResponseValue201ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateCreditsProductResponseValue201ApplicationJsonPropertyData {
...
impl CreateCreditsProductResponseValue201ApplicationJsonPropertyData {
