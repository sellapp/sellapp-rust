...
#[serde(remote = "Self")]
pub struct SearchUpsellOffersRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchUpsellOffersRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchUpsellOffersRequestApplicationJsonPropertySearch {
...
impl SearchUpsellOffersRequestApplicationJsonPropertySearch {
