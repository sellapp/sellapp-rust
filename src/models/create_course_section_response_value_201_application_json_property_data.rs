...
#[serde(remote = "Self")]
pub struct CreateCourseSectionResponseValue201ApplicationJsonPropertyData {
    pub id: i64,
    pub title: String,
    ...
    pub lessons: Option<
        Vec<CreateCourseSectionResponseValue201ApplicationJsonPropertyDataPropertyLessonsItem>,
    >,
...
impl Serialize for CreateCourseSectionResponseValue201ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateCourseSectionResponseValue201ApplicationJsonPropertyData {
...
impl CreateCourseSectionResponseValue201ApplicationJsonPropertyData {
