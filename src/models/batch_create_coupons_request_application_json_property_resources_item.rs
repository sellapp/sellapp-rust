...
#[serde(remote = "Self")]
pub struct BatchCreateCouponsRequestApplicationJsonPropertyResourcesItem {
    pub code: String,
    #[serde(rename = "type")]
    pub type_: BatchCreateCouponsRequestApplicationJsonPropertyResourcesItemType,
...
impl Serialize for BatchCreateCouponsRequestApplicationJsonPropertyResourcesItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for BatchCreateCouponsRequestApplicationJsonPropertyResourcesItem {
...
impl BatchCreateCouponsRequestApplicationJsonPropertyResourcesItem {
