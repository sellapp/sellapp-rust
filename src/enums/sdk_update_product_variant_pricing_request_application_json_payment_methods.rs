...
#[non_exhaustive]
pub enum SdkUpdateProductVariantPricingRequestApplicationJsonPaymentMethods {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl SdkUpdateProductVariantPricingRequestApplicationJsonPaymentMethods {
...
impl fmt::Display for SdkUpdateProductVariantPricingRequestApplicationJsonPaymentMethods {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkUpdateProductVariantPricingRequestApplicationJsonPaymentMethods {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkUpdateProductVariantPricingRequestApplicationJsonPaymentMethods {
...
impl From<String> for SdkUpdateProductVariantPricingRequestApplicationJsonPaymentMethods {
...
impl From<&str> for SdkUpdateProductVariantPricingRequestApplicationJsonPaymentMethods {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkUpdateProductVariantPricingRequestApplicationJsonPaymentMethods {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkUpdateProductVariantPricingRequestApplicationJsonPaymentMethods {
