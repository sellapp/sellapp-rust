...
#[serde(remote = "Self")]
pub struct GetAccountResponseValue200ApplicationJsonPropertyData {
    pub id: String,
    pub username: Option<String>,
    pub email: String,
    pub credential_type: GetAccountResponseValue200ApplicationJsonPropertyDataCredentialType,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for GetAccountResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for GetAccountResponseValue200ApplicationJsonPropertyData {
...
impl GetAccountResponseValue200ApplicationJsonPropertyData {
