...
#[serde(remote = "Self")]
pub struct ListDisputesResponseValue200ApplicationJsonPropertyDataItemPropertySource {
    #[serde(rename = "type")]
...
impl Serialize for ListDisputesResponseValue200ApplicationJsonPropertyDataItemPropertySource {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ListDisputesResponseValue200ApplicationJsonPropertyDataItemPropertySource
{
...
impl ListDisputesResponseValue200ApplicationJsonPropertyDataItemPropertySource {
