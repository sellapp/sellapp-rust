...
#[non_exhaustive]
pub enum ListPaymentMethodsResponseValue200ApplicationJsonPropertyDataItemConnectionType {
    OAuth,
    ApiKeys,
    Wallet,
    Custom,
...
impl ListPaymentMethodsResponseValue200ApplicationJsonPropertyDataItemConnectionType {
...
impl fmt::Display
    for ListPaymentMethodsResponseValue200ApplicationJsonPropertyDataItemConnectionType
{
...
impl FromStr for ListPaymentMethodsResponseValue200ApplicationJsonPropertyDataItemConnectionType {
...
impl Serialize for ListPaymentMethodsResponseValue200ApplicationJsonPropertyDataItemConnectionType {
