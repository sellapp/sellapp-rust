...
#[serde(remote = "Self")]
pub struct V2GetCouponResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: V2GetCouponResponseValue200ApplicationJsonPropertyDataType,
    pub discount: String,
...
impl Serialize for V2GetCouponResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2GetCouponResponseValue200ApplicationJsonPropertyData {
...
impl V2GetCouponResponseValue200ApplicationJsonPropertyData {
