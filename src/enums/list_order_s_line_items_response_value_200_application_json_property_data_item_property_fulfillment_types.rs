...
#[non_exhaustive]
pub enum ListOrderSLineItemsResponseValue200ApplicationJsonPropertyDataItemPropertyFulfillmentTypes
{
    Downloadable,
    Text,
    Dynamic,
...
impl ListOrderSLineItemsResponseValue200ApplicationJsonPropertyDataItemPropertyFulfillmentTypes {
...
impl fmt::Display
    for ListOrderSLineItemsResponseValue200ApplicationJsonPropertyDataItemPropertyFulfillmentTypes
{
