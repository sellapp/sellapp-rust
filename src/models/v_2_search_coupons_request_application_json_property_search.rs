...
#[serde(remote = "Self")]
pub struct V2SearchCouponsRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for V2SearchCouponsRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2SearchCouponsRequestApplicationJsonPropertySearch {
...
impl V2SearchCouponsRequestApplicationJsonPropertySearch {
