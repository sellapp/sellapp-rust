...
#[serde(remote = "Self")]
pub struct SdkAddHighlightMediaRequestMultipartFormData {
    pub file: Vec<u8>,
...
impl Serialize for SdkAddHighlightMediaRequestMultipartFormData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkAddHighlightMediaRequestMultipartFormData {
...
impl SdkAddHighlightMediaRequestMultipartFormData {
    ...
    pub fn validate_request(&self) -> Result<(), crate::error::Error> {
        ...
        crate::runtime_schema::model(&value, "SdkAddHighlightMediaRequestMultipartFormData", true)
    }
}
