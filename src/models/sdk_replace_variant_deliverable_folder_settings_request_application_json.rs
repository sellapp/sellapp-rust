...
#[serde(remote = "Self")]
pub struct SdkReplaceVariantDeliverableFolderSettingsRequestApplicationJson {
...
impl Serialize for SdkReplaceVariantDeliverableFolderSettingsRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkReplaceVariantDeliverableFolderSettingsRequestApplicationJson {
...
impl SdkReplaceVariantDeliverableFolderSettingsRequestApplicationJson {
