...
#[serde(remote = "Self")]
pub struct SdkReplaceVariantDeliverableFileSettingsRequestApplicationJson {
    #[serde(
...
impl Serialize for SdkReplaceVariantDeliverableFileSettingsRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkReplaceVariantDeliverableFileSettingsRequestApplicationJson {
...
impl SdkReplaceVariantDeliverableFileSettingsRequestApplicationJson {
