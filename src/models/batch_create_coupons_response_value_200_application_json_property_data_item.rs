...
#[serde(remote = "Self")]
pub struct BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItemType,
    pub discount: String,
...
impl Serialize for BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItem {
...
impl BatchCreateCouponsResponseValue200ApplicationJsonPropertyDataItem {
