...
#[serde(remote = "Self")]
pub struct V2UpdateCouponResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: V2UpdateCouponResponseValue200ApplicationJsonPropertyDataType,
    pub discount: String,
...
impl Serialize for V2UpdateCouponResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2UpdateCouponResponseValue200ApplicationJsonPropertyData {
...
impl V2UpdateCouponResponseValue200ApplicationJsonPropertyData {
