...
#[non_exhaustive]
pub enum ConfirmSubscriptionRenewalDateChangeResponseValue200ApplicationJsonPropertyDataAction {
    Pause,
    Resume,
    CancelAtPeriodEnd,
    CancelImmediately,
...
impl ConfirmSubscriptionRenewalDateChangeResponseValue200ApplicationJsonPropertyDataAction {
...
impl fmt::Display
    for ConfirmSubscriptionRenewalDateChangeResponseValue200ApplicationJsonPropertyDataAction
{
