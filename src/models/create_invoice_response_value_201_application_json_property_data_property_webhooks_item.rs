...
#[serde(remote = "Self")]
pub struct CreateInvoiceResponseValue201ApplicationJsonPropertyDataPropertyWebhooksItem {
    pub url: String,
...
impl Serialize for CreateInvoiceResponseValue201ApplicationJsonPropertyDataPropertyWebhooksItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for CreateInvoiceResponseValue201ApplicationJsonPropertyDataPropertyWebhooksItem
{
...
impl CreateInvoiceResponseValue201ApplicationJsonPropertyDataPropertyWebhooksItem {
