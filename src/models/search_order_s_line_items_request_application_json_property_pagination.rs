...
#[serde(remote = "Self")]
pub struct SearchOrderSLineItemsRequestApplicationJsonPropertyPagination {
    /// Defaults to `1`.
...
impl Serialize for SearchOrderSLineItemsRequestApplicationJsonPropertyPagination {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchOrderSLineItemsRequestApplicationJsonPropertyPagination {
...
impl SearchOrderSLineItemsRequestApplicationJsonPropertyPagination {
