...
#[serde(remote = "Self")]
pub struct SdkUploadVariantDeliverableFileRequestMultipartFormData {
    pub file: Vec<u8>,
    #[serde(
...
impl Serialize for SdkUploadVariantDeliverableFileRequestMultipartFormData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkUploadVariantDeliverableFileRequestMultipartFormData {
...
impl SdkUploadVariantDeliverableFileRequestMultipartFormData {
