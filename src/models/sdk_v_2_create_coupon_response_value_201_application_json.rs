...
#[serde(remote = "Self")]
pub struct SdkV2CreateCouponResponseValue201ApplicationJson {
    pub data: V2CreateCouponResponseValue201ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkV2CreateCouponResponseValue201ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkV2CreateCouponResponseValue201ApplicationJson {
...
impl SdkV2CreateCouponResponseValue201ApplicationJson {
