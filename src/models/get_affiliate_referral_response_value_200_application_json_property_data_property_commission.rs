...
#[serde(remote = "Self")]
pub struct GetAffiliateReferralResponseValue200ApplicationJsonPropertyDataPropertyCommission {
    #[serde(rename = "type")]
    pub type_:
...
impl Serialize
    for GetAffiliateReferralResponseValue200ApplicationJsonPropertyDataPropertyCommission
{
...
impl GetAffiliateReferralResponseValue200ApplicationJsonPropertyDataPropertyCommission {
