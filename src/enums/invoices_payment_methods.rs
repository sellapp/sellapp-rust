...
#[non_exhaustive]
pub enum InvoicesPaymentMethods {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl fmt::Display for InvoicesPaymentMethods {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for InvoicesPaymentMethods {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for InvoicesPaymentMethods {
...
impl From<String> for InvoicesPaymentMethods {
...
impl From<&str> for InvoicesPaymentMethods {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for InvoicesPaymentMethods {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for InvoicesPaymentMethods {
