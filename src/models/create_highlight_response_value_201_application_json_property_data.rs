...
#[serde(remote = "Self")]
pub struct CreateHighlightResponseValue201ApplicationJsonPropertyData {
    pub id: i64,
    pub title: String,
    pub hidden: bool,
    pub sort_order: Option<i64>,
    pub published_at: Option<String>,
    pub media: Vec<CreateHighlightResponseValue201ApplicationJsonPropertyDataPropertyMediaItem>,
...
impl Serialize for CreateHighlightResponseValue201ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateHighlightResponseValue201ApplicationJsonPropertyData {
...
impl CreateHighlightResponseValue201ApplicationJsonPropertyData {
