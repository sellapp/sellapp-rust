...
#[serde(remote = "Self")]
pub struct SdkCreateCouponRequestApplicationJson {
    pub code: String,
    #[serde(rename = "type")]
    pub type_: SdkCreateCouponRequestApplicationJsonType,
...
impl Serialize for SdkCreateCouponRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateCouponRequestApplicationJson {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let mut value = serde_json::Value::deserialize(deserializer)?;
        crate::runtime_schema::model(&value, "SdkCreateCouponRequestApplicationJson", false)
...
impl SdkCreateCouponRequestApplicationJson {
    ...
    pub fn validate_request(&self) -> Result<(), crate::error::Error> {
        ...
        crate::runtime_schema::model(&value, "SdkCreateCouponRequestApplicationJson", true)
    }
}
