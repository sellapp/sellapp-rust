...
impl fmt::Display for InvoicesStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for InvoicesStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for InvoicesStatus {
...
impl From<String> for InvoicesStatus {
...
impl From<&str> for InvoicesStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for InvoicesStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for InvoicesStatus {
