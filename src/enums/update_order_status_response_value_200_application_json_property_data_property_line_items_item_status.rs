...
#[non_exhaustive]
pub enum UpdateOrderStatusResponseValue200ApplicationJsonPropertyDataPropertyLineItemsItemStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl UpdateOrderStatusResponseValue200ApplicationJsonPropertyDataPropertyLineItemsItemStatus {
...
impl fmt::Display
    for UpdateOrderStatusResponseValue200ApplicationJsonPropertyDataPropertyLineItemsItemStatus
{
