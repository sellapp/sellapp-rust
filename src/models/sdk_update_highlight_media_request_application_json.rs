...
#[serde(remote = "Self")]
pub struct SdkUpdateHighlightMediaRequestApplicationJson {
...
impl Serialize for SdkUpdateHighlightMediaRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkUpdateHighlightMediaRequestApplicationJson {
...
impl SdkUpdateHighlightMediaRequestApplicationJson {
