...
#[non_exhaustive]
pub enum CreateCourseSectionResponseValue201ApplicationJsonPropertyDataPropertyLessonsItemType {
    Lecture,
    Video,
    Text,
    Quiz,
...
impl CreateCourseSectionResponseValue201ApplicationJsonPropertyDataPropertyLessonsItemType {
...
impl fmt::Display
    for CreateCourseSectionResponseValue201ApplicationJsonPropertyDataPropertyLessonsItemType
{
