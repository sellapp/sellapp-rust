...
#[non_exhaustive]
pub enum SdkCreateProductRequestApplicationJsonType {
    Product,
    Bundle,
...
impl SdkCreateProductRequestApplicationJsonType {
...
impl fmt::Display for SdkCreateProductRequestApplicationJsonType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkCreateProductRequestApplicationJsonType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkCreateProductRequestApplicationJsonType {
...
impl From<String> for SdkCreateProductRequestApplicationJsonType {
...
impl From<&str> for SdkCreateProductRequestApplicationJsonType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkCreateProductRequestApplicationJsonType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkCreateProductRequestApplicationJsonType {
