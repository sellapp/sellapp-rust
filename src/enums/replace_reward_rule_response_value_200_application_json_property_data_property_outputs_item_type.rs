...
#[non_exhaustive]
pub enum ReplaceRewardRuleResponseValue200ApplicationJsonPropertyDataPropertyOutputsItemType {
    WalletCredit,
    Coupon,
    Badge,
    StatusLabel,
...
impl ReplaceRewardRuleResponseValue200ApplicationJsonPropertyDataPropertyOutputsItemType {
...
impl fmt::Display
    for ReplaceRewardRuleResponseValue200ApplicationJsonPropertyDataPropertyOutputsItemType
{
