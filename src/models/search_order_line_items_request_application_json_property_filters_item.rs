...
#[serde(remote = "Self")]
pub struct SearchOrderLineItemsRequestApplicationJsonPropertyFiltersItem {
    pub field: String,
    pub operator: SearchOrderLineItemsRequestApplicationJsonPropertyFiltersItemOperator,
    pub value: serde_json::Value,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SearchOrderLineItemsRequestApplicationJsonPropertyFiltersItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchOrderLineItemsRequestApplicationJsonPropertyFiltersItem {
...
impl SearchOrderLineItemsRequestApplicationJsonPropertyFiltersItem {
