...
#[serde(remote = "Self")]
pub struct SdkV2ReplaceSectionOrderResponseValue200ApplicationJson {
    pub data: Vec<V2ReplaceSectionOrderResponseValue200ApplicationJsonPropertyDataItem>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkV2ReplaceSectionOrderResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkV2ReplaceSectionOrderResponseValue200ApplicationJson {
...
impl SdkV2ReplaceSectionOrderResponseValue200ApplicationJson {
