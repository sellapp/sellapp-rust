...
#[serde(remote = "Self")]
pub struct V2SearchTicketMessagesRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for V2SearchTicketMessagesRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2SearchTicketMessagesRequestApplicationJsonPropertySearch {
...
impl V2SearchTicketMessagesRequestApplicationJsonPropertySearch {
