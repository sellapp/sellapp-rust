...
#[non_exhaustive]
pub enum CreateWalletOrderResponseValue201ApplicationJsonPropertyDataPropertyLineItemsItemStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl CreateWalletOrderResponseValue201ApplicationJsonPropertyDataPropertyLineItemsItemStatus {
...
impl fmt::Display
    for CreateWalletOrderResponseValue201ApplicationJsonPropertyDataPropertyLineItemsItemStatus
{
