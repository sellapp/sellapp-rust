...
#[non_exhaustive]
pub enum UpdateRewardRuleResponseValue200ApplicationJsonPropertyDataPropertyOutputsItemType {
    WalletCredit,
    Coupon,
    Badge,
    StatusLabel,
...
impl UpdateRewardRuleResponseValue200ApplicationJsonPropertyDataPropertyOutputsItemType {
...
impl fmt::Display
    for UpdateRewardRuleResponseValue200ApplicationJsonPropertyDataPropertyOutputsItemType
{
