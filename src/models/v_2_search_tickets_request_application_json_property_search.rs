...
#[serde(remote = "Self")]
pub struct V2SearchTicketsRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for V2SearchTicketsRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2SearchTicketsRequestApplicationJsonPropertySearch {
...
impl V2SearchTicketsRequestApplicationJsonPropertySearch {
