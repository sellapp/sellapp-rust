...
#[serde(remote = "Self")]
pub struct ReplaceProductRequestApplicationJsonPropertyOtherSettings {
...
impl Serialize for ReplaceProductRequestApplicationJsonPropertyOtherSettings {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ReplaceProductRequestApplicationJsonPropertyOtherSettings {
...
impl ReplaceProductRequestApplicationJsonPropertyOtherSettings {
