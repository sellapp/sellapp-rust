...
#[serde(remote = "Self")]
pub struct ReplaceProductVariantPricingRequestApplicationJsonPropertyBulkDiscountItem {
...
impl Serialize for ReplaceProductVariantPricingRequestApplicationJsonPropertyBulkDiscountItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ReplaceProductVariantPricingRequestApplicationJsonPropertyBulkDiscountItem
{
...
impl ReplaceProductVariantPricingRequestApplicationJsonPropertyBulkDiscountItem {
