...
#[serde(remote = "Self")]
pub struct SearchOrdersRequestApplicationJsonPropertyPagination {
    /// Defaults to `1`.
...
impl Serialize for SearchOrdersRequestApplicationJsonPropertyPagination {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchOrdersRequestApplicationJsonPropertyPagination {
...
impl SearchOrdersRequestApplicationJsonPropertyPagination {
