...
#[serde(remote = "Self")]
pub struct ReplaceCreditsProductRequestApplicationJsonPropertyRateTiersItem {
...
impl Serialize for ReplaceCreditsProductRequestApplicationJsonPropertyRateTiersItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ReplaceCreditsProductRequestApplicationJsonPropertyRateTiersItem {
...
impl ReplaceCreditsProductRequestApplicationJsonPropertyRateTiersItem {
