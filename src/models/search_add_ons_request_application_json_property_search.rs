...
#[serde(remote = "Self")]
pub struct SearchAddOnsRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchAddOnsRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchAddOnsRequestApplicationJsonPropertySearch {
...
impl SearchAddOnsRequestApplicationJsonPropertySearch {
