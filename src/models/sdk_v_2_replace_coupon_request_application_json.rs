...
#[serde(remote = "Self")]
pub struct SdkV2ReplaceCouponRequestApplicationJson {
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub code: Option<String>,
    #[serde(rename = "type")]
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub type_: Option<SdkV2ReplaceCouponRequestApplicationJsonType>,
...
impl Serialize for SdkV2ReplaceCouponRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkV2ReplaceCouponRequestApplicationJson {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let mut value = serde_json::Value::deserialize(deserializer)?;
        crate::runtime_schema::model(&value, "SdkV2ReplaceCouponRequestApplicationJson", false)
...
impl SdkV2ReplaceCouponRequestApplicationJson {
    ...
    pub fn validate_request(&self) -> Result<(), crate::error::Error> {
        ...
        crate::runtime_schema::model(&value, "SdkV2ReplaceCouponRequestApplicationJson", true)
    }
}
