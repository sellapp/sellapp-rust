...
#[serde(remote = "Self")]
pub struct UpdateProductVariantRequestApplicationJsonPropertyOtherSettings {
...
impl Serialize for UpdateProductVariantRequestApplicationJsonPropertyOtherSettings {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for UpdateProductVariantRequestApplicationJsonPropertyOtherSettings {
...
impl UpdateProductVariantRequestApplicationJsonPropertyOtherSettings {
