...
#[serde(remote = "Self")]
pub struct SdkIssueEligibleRewardGrantResponseValue200ApplicationJson {
    pub data: IssueEligibleRewardGrantResponseValue200ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkIssueEligibleRewardGrantResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkIssueEligibleRewardGrantResponseValue200ApplicationJson {
...
impl SdkIssueEligibleRewardGrantResponseValue200ApplicationJson {
