...
#[non_exhaustive]
pub enum CreateOrderRefundResponseValue200ApplicationJsonPropertyDataPropertyOrderStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl CreateOrderRefundResponseValue200ApplicationJsonPropertyDataPropertyOrderStatus {
...
impl fmt::Display
    for CreateOrderRefundResponseValue200ApplicationJsonPropertyDataPropertyOrderStatus
{
...
impl FromStr for CreateOrderRefundResponseValue200ApplicationJsonPropertyDataPropertyOrderStatus {
...
impl Serialize for CreateOrderRefundResponseValue200ApplicationJsonPropertyDataPropertyOrderStatus {
