...
#[serde(remote = "Self")]
pub struct CreateCustomerResponseValue201ApplicationJsonPropertyDataPropertyWallet {
    pub status: CreateCustomerResponseValue201ApplicationJsonPropertyDataPropertyWalletStatus,
...
impl Serialize for CreateCustomerResponseValue201ApplicationJsonPropertyDataPropertyWallet {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for CreateCustomerResponseValue201ApplicationJsonPropertyDataPropertyWallet
{
...
impl CreateCustomerResponseValue201ApplicationJsonPropertyDataPropertyWallet {
