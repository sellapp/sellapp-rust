...
#[serde(remote = "Self")]
pub struct SdkRetryOrderFulfillmentRequestApplicationJson {
...
impl Serialize for SdkRetryOrderFulfillmentRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkRetryOrderFulfillmentRequestApplicationJson {
...
impl SdkRetryOrderFulfillmentRequestApplicationJson {
