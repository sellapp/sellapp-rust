...
#[serde(remote = "Self")]
pub struct ListIntegrationEventsResponseValue200ApplicationJsonPropertyDataItemPropertyData {
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize
    for ListIntegrationEventsResponseValue200ApplicationJsonPropertyDataItemPropertyData
{
...
impl ListIntegrationEventsResponseValue200ApplicationJsonPropertyDataItemPropertyData {
