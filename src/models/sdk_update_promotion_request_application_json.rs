...
#[serde(remote = "Self")]
pub struct SdkUpdatePromotionRequestApplicationJson {
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub name: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub status: Option<SdkUpdatePromotionRequestApplicationJsonStatus>,
    #[serde(
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub phases: Option<Vec<UpdatePromotionRequestApplicationJsonPropertyPhasesItem>>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkUpdatePromotionRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkUpdatePromotionRequestApplicationJson {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let mut value = serde_json::Value::deserialize(deserializer)?;
        crate::runtime_schema::model(&value, "SdkUpdatePromotionRequestApplicationJson", false)
...
impl SdkUpdatePromotionRequestApplicationJson {
    ...
    pub fn validate_request(&self) -> Result<(), crate::error::Error> {
        ...
        crate::runtime_schema::model(&value, "SdkUpdatePromotionRequestApplicationJson", true)
    }
}
