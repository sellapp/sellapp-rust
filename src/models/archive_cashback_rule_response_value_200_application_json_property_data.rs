...
#[serde(remote = "Self")]
pub struct ArchiveCashbackRuleResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
...
impl Serialize for ArchiveCashbackRuleResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ArchiveCashbackRuleResponseValue200ApplicationJsonPropertyData {
...
impl ArchiveCashbackRuleResponseValue200ApplicationJsonPropertyData {
