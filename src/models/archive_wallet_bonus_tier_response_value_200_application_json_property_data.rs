...
#[serde(remote = "Self")]
pub struct ArchiveWalletBonusTierResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub minimum_top_up_cents: i64,
    pub bonus_kind: ArchiveWalletBonusTierResponseValue200ApplicationJsonPropertyDataBonusKind,
...
impl Serialize for ArchiveWalletBonusTierResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ArchiveWalletBonusTierResponseValue200ApplicationJsonPropertyData {
...
impl ArchiveWalletBonusTierResponseValue200ApplicationJsonPropertyData {
