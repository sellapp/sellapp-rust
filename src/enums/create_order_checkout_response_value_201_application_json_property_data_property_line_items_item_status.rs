...
#[non_exhaustive]
pub enum CreateOrderCheckoutResponseValue201ApplicationJsonPropertyDataPropertyLineItemsItemStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl CreateOrderCheckoutResponseValue201ApplicationJsonPropertyDataPropertyLineItemsItemStatus {
...
impl fmt::Display
    for CreateOrderCheckoutResponseValue201ApplicationJsonPropertyDataPropertyLineItemsItemStatus
{
