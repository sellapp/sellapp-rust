...
#[serde(remote = "Self")]
pub struct CancelAppointmentResponseValue200ApplicationJsonPropertyDataPropertyVariant {
    #[serde(
...
impl Serialize for CancelAppointmentResponseValue200ApplicationJsonPropertyDataPropertyVariant {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for CancelAppointmentResponseValue200ApplicationJsonPropertyDataPropertyVariant
{
...
impl CancelAppointmentResponseValue200ApplicationJsonPropertyDataPropertyVariant {
