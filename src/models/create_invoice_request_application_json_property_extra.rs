...
#[serde(remote = "Self")]
pub struct CreateInvoiceRequestApplicationJsonPropertyExtra {
    pub amount: i64,
    pub currency: String,
...
impl Serialize for CreateInvoiceRequestApplicationJsonPropertyExtra {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateInvoiceRequestApplicationJsonPropertyExtra {
...
impl CreateInvoiceRequestApplicationJsonPropertyExtra {
