...
#[serde(remote = "Self")]
pub struct ListInvoicesResponseValue200ApplicationJsonPropertyDataItemPropertyWebhooksItem {
    pub url: String,
...
impl Serialize for ListInvoicesResponseValue200ApplicationJsonPropertyDataItemPropertyWebhooksItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ListInvoicesResponseValue200ApplicationJsonPropertyDataItemPropertyWebhooksItem
{
...
impl ListInvoicesResponseValue200ApplicationJsonPropertyDataItemPropertyWebhooksItem {
