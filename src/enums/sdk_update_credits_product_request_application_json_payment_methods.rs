...
#[non_exhaustive]
pub enum SdkUpdateCreditsProductRequestApplicationJsonPaymentMethods {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl SdkUpdateCreditsProductRequestApplicationJsonPaymentMethods {
...
impl fmt::Display for SdkUpdateCreditsProductRequestApplicationJsonPaymentMethods {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkUpdateCreditsProductRequestApplicationJsonPaymentMethods {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkUpdateCreditsProductRequestApplicationJsonPaymentMethods {
...
impl From<String> for SdkUpdateCreditsProductRequestApplicationJsonPaymentMethods {
...
impl From<&str> for SdkUpdateCreditsProductRequestApplicationJsonPaymentMethods {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkUpdateCreditsProductRequestApplicationJsonPaymentMethods {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkUpdateCreditsProductRequestApplicationJsonPaymentMethods {
