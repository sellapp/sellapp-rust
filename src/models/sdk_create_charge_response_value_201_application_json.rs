...
#[serde(remote = "Self")]
pub struct SdkCreateChargeResponseValue201ApplicationJson {
    pub data: CreateChargeResponseValue201ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkCreateChargeResponseValue201ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateChargeResponseValue201ApplicationJson {
...
impl SdkCreateChargeResponseValue201ApplicationJson {
