...
#[serde(remote = "Self")]
pub struct SdkCreateCreditsProductRequestApplicationJson {
    pub title: String,
    ...
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub payment_methods: Option<Vec<SdkCreateCreditsProductRequestApplicationJsonPaymentMethods>>,
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub rate_tiers: Option<Vec<CreateCreditsProductRequestApplicationJsonPropertyRateTiersItem>>,
    #[serde(skip_serializing_if = "Option::is_none", default)]
...
impl Serialize for SdkCreateCreditsProductRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateCreditsProductRequestApplicationJson {
...
impl SdkCreateCreditsProductRequestApplicationJson {
