...
#[non_exhaustive]
pub enum SdkCreateCreditsProductRequestApplicationJsonPaymentMethods {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl SdkCreateCreditsProductRequestApplicationJsonPaymentMethods {
...
impl fmt::Display for SdkCreateCreditsProductRequestApplicationJsonPaymentMethods {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkCreateCreditsProductRequestApplicationJsonPaymentMethods {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkCreateCreditsProductRequestApplicationJsonPaymentMethods {
...
impl From<String> for SdkCreateCreditsProductRequestApplicationJsonPaymentMethods {
...
impl From<&str> for SdkCreateCreditsProductRequestApplicationJsonPaymentMethods {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkCreateCreditsProductRequestApplicationJsonPaymentMethods {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkCreateCreditsProductRequestApplicationJsonPaymentMethods {
