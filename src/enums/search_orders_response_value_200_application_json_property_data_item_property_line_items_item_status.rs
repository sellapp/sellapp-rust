...
#[non_exhaustive]
pub enum SearchOrdersResponseValue200ApplicationJsonPropertyDataItemPropertyLineItemsItemStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl SearchOrdersResponseValue200ApplicationJsonPropertyDataItemPropertyLineItemsItemStatus {
...
impl fmt::Display
    for SearchOrdersResponseValue200ApplicationJsonPropertyDataItemPropertyLineItemsItemStatus
{
