...
#[serde(remote = "Self")]
pub struct SearchFeedbackResponseValue200ApplicationJsonPropertyDataItemPropertyMetadata {
...
impl Serialize for SearchFeedbackResponseValue200ApplicationJsonPropertyDataItemPropertyMetadata {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for SearchFeedbackResponseValue200ApplicationJsonPropertyDataItemPropertyMetadata
{
...
impl SearchFeedbackResponseValue200ApplicationJsonPropertyDataItemPropertyMetadata {
