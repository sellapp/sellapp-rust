...
#[serde(remote = "Self")]
pub struct SdkMarkPendingInvoiceVoidedRequestApplicationJson {
...
impl Serialize for SdkMarkPendingInvoiceVoidedRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkMarkPendingInvoiceVoidedRequestApplicationJson {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let mut value = serde_json::Value::deserialize(deserializer)?;
        crate::runtime_schema::model(
            &value,
            "SdkMarkPendingInvoiceVoidedRequestApplicationJson",
            false,
        )
...
impl SdkMarkPendingInvoiceVoidedRequestApplicationJson {
