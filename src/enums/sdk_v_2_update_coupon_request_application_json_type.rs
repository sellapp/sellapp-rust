...
#[non_exhaustive]
pub enum SdkV2UpdateCouponRequestApplicationJsonType {
    Percentage,
    Amount,
...
impl SdkV2UpdateCouponRequestApplicationJsonType {
...
impl fmt::Display for SdkV2UpdateCouponRequestApplicationJsonType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkV2UpdateCouponRequestApplicationJsonType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkV2UpdateCouponRequestApplicationJsonType {
...
impl From<String> for SdkV2UpdateCouponRequestApplicationJsonType {
...
impl From<&str> for SdkV2UpdateCouponRequestApplicationJsonType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkV2UpdateCouponRequestApplicationJsonType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkV2UpdateCouponRequestApplicationJsonType {
