...
#[non_exhaustive]
pub enum SdkUpdateOrderStatusRequestApplicationJsonStatus {
    Completed,
    Voided,
    Review,
    Disputing,
...
impl SdkUpdateOrderStatusRequestApplicationJsonStatus {
...
impl fmt::Display for SdkUpdateOrderStatusRequestApplicationJsonStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkUpdateOrderStatusRequestApplicationJsonStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkUpdateOrderStatusRequestApplicationJsonStatus {
...
impl From<String> for SdkUpdateOrderStatusRequestApplicationJsonStatus {
...
impl From<&str> for SdkUpdateOrderStatusRequestApplicationJsonStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkUpdateOrderStatusRequestApplicationJsonStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkUpdateOrderStatusRequestApplicationJsonStatus {
