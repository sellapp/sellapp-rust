...
#[serde(remote = "Self")]
pub struct SdkReplaceProductVariantPricingResponseValue200ApplicationJson {
    pub data: ReplaceProductVariantPricingResponseValue200ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkReplaceProductVariantPricingResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkReplaceProductVariantPricingResponseValue200ApplicationJson {
...
impl SdkReplaceProductVariantPricingResponseValue200ApplicationJson {
