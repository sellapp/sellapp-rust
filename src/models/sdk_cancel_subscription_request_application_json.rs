...
#[serde(remote = "Self")]
pub struct SdkCancelSubscriptionRequestApplicationJson {
    ...
    pub refund_last_payment: Option<bool>,
    ...
    /// Defaults to `false`.
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub pro_rated_refund: Option<bool>,
...
impl Serialize for SdkCancelSubscriptionRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCancelSubscriptionRequestApplicationJson {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let mut value = serde_json::Value::deserialize(deserializer)?;
        crate::runtime_schema::model(&value, "SdkCancelSubscriptionRequestApplicationJson", false)
...
impl SdkCancelSubscriptionRequestApplicationJson {
    ...
    pub fn validate_request(&self) -> Result<(), crate::error::Error> {
        ...
        crate::runtime_schema::model(&value, "SdkCancelSubscriptionRequestApplicationJson", true)
    }
}
