...
#[serde(remote = "Self")]
pub struct SdkRotateWebhookSigningSecretResponseValue200ApplicationJson {
    pub data: RotateWebhookSigningSecretResponseValue200ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkRotateWebhookSigningSecretResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkRotateWebhookSigningSecretResponseValue200ApplicationJson {
...
impl SdkRotateWebhookSigningSecretResponseValue200ApplicationJson {
