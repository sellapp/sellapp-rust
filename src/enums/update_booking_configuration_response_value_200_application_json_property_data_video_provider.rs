...
#[non_exhaustive]
pub enum UpdateBookingConfigurationResponseValue200ApplicationJsonPropertyDataVideoProvider {
    None,
    GoogleMeet,
    Zoom,
...
impl UpdateBookingConfigurationResponseValue200ApplicationJsonPropertyDataVideoProvider {
...
impl fmt::Display
    for UpdateBookingConfigurationResponseValue200ApplicationJsonPropertyDataVideoProvider
{
