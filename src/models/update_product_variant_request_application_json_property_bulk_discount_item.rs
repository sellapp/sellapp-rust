...
#[serde(remote = "Self")]
pub struct UpdateProductVariantRequestApplicationJsonPropertyBulkDiscountItem {
...
impl Serialize for UpdateProductVariantRequestApplicationJsonPropertyBulkDiscountItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for UpdateProductVariantRequestApplicationJsonPropertyBulkDiscountItem {
...
impl UpdateProductVariantRequestApplicationJsonPropertyBulkDiscountItem {
