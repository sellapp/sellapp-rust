...
#[serde(remote = "Self")]
pub struct SdkMarkPendingInvoiceCompletedRequestApplicationJson {
...
impl Serialize for SdkMarkPendingInvoiceCompletedRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkMarkPendingInvoiceCompletedRequestApplicationJson {
...
impl SdkMarkPendingInvoiceCompletedRequestApplicationJson {
