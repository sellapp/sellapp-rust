...
#[serde(remote = "Self")]
pub struct SearchTicketsRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchTicketsRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchTicketsRequestApplicationJsonPropertySearch {
...
impl SearchTicketsRequestApplicationJsonPropertySearch {
