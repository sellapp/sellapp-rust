...
#[serde(remote = "Self")]
pub struct UpdateProductVariantPricingRequestApplicationJsonPropertyBulkDiscountItem {
...
impl Serialize for UpdateProductVariantPricingRequestApplicationJsonPropertyBulkDiscountItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for UpdateProductVariantPricingRequestApplicationJsonPropertyBulkDiscountItem
{
...
impl UpdateProductVariantPricingRequestApplicationJsonPropertyBulkDiscountItem {
