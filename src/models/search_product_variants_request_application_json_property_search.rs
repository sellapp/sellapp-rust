...
#[serde(remote = "Self")]
pub struct SearchProductVariantsRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchProductVariantsRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchProductVariantsRequestApplicationJsonPropertySearch {
...
impl SearchProductVariantsRequestApplicationJsonPropertySearch {
