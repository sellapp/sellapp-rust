...
impl AsRef<str> for StoreVisibility {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl From<String> for StoreVisibility {
...
impl From<&str> for StoreVisibility {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for StoreVisibility {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for StoreVisibility {
