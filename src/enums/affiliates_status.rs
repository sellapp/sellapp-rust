...
impl fmt::Display for AffiliatesStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for AffiliatesStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for AffiliatesStatus {
...
impl From<String> for AffiliatesStatus {
...
impl From<&str> for AffiliatesStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for AffiliatesStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for AffiliatesStatus {
