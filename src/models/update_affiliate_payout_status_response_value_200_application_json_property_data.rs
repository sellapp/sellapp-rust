...
#[serde(remote = "Self")]
pub struct UpdateAffiliatePayoutStatusResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub affiliate_id: i64,
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub affiliate_email: Option<String>,
    pub amount_usd_cents: i64,
    pub status: UpdateAffiliatePayoutStatusResponseValue200ApplicationJsonPropertyDataStatus,
    #[serde(
...
impl Serialize for UpdateAffiliatePayoutStatusResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for UpdateAffiliatePayoutStatusResponseValue200ApplicationJsonPropertyData
{
...
impl UpdateAffiliatePayoutStatusResponseValue200ApplicationJsonPropertyData {
