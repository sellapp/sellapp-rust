...
#[non_exhaustive]
pub enum CreateWalletOrderResponseValue201ApplicationJsonPropertyDataPropertyTimelineItemStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl CreateWalletOrderResponseValue201ApplicationJsonPropertyDataPropertyTimelineItemStatus {
...
impl fmt::Display
    for CreateWalletOrderResponseValue201ApplicationJsonPropertyDataPropertyTimelineItemStatus
{
