...
#[serde(remote = "Self")]
pub struct SearchOrderLineItemsRequestApplicationJsonPropertyPagination {
    /// Defaults to `1`.
...
impl Serialize for SearchOrderLineItemsRequestApplicationJsonPropertyPagination {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchOrderLineItemsRequestApplicationJsonPropertyPagination {
...
impl SearchOrderLineItemsRequestApplicationJsonPropertyPagination {
