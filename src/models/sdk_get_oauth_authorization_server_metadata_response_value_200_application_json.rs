...
#[serde(remote = "Self")]
pub struct SdkGetOAuthAuthorizationServerMetadataResponseValue200ApplicationJson {
    pub issuer: String,
...
impl Serialize for SdkGetOAuthAuthorizationServerMetadataResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for SdkGetOAuthAuthorizationServerMetadataResponseValue200ApplicationJson
{
...
impl SdkGetOAuthAuthorizationServerMetadataResponseValue200ApplicationJson {
