...
#[serde(remote = "Self")]
pub struct V2CreateCouponResponseValue201ApplicationJsonPropertyData {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: V2CreateCouponResponseValue201ApplicationJsonPropertyDataType,
    pub discount: String,
...
impl Serialize for V2CreateCouponResponseValue201ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2CreateCouponResponseValue201ApplicationJsonPropertyData {
...
impl V2CreateCouponResponseValue201ApplicationJsonPropertyData {
