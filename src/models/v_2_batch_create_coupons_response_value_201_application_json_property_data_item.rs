...
#[serde(remote = "Self")]
pub struct V2BatchCreateCouponsResponseValue201ApplicationJsonPropertyDataItem {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: V2BatchCreateCouponsResponseValue201ApplicationJsonPropertyDataItemType,
    pub discount: String,
...
impl Serialize for V2BatchCreateCouponsResponseValue201ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2BatchCreateCouponsResponseValue201ApplicationJsonPropertyDataItem {
...
impl V2BatchCreateCouponsResponseValue201ApplicationJsonPropertyDataItem {
