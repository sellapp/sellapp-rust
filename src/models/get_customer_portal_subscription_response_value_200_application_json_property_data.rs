...
#[serde(remote = "Self")]
pub struct GetCustomerPortalSubscriptionResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub status: String,
    #[serde(
...
impl Serialize for GetCustomerPortalSubscriptionResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for GetCustomerPortalSubscriptionResponseValue200ApplicationJsonPropertyData
{
...
impl GetCustomerPortalSubscriptionResponseValue200ApplicationJsonPropertyData {
