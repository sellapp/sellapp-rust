...
#[non_exhaustive]
pub enum CreateWalletTopUpResponseValue201ApplicationJsonPropertyDataPaymentMethod {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl CreateWalletTopUpResponseValue201ApplicationJsonPropertyDataPaymentMethod {
...
impl fmt::Display for CreateWalletTopUpResponseValue201ApplicationJsonPropertyDataPaymentMethod {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for CreateWalletTopUpResponseValue201ApplicationJsonPropertyDataPaymentMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for CreateWalletTopUpResponseValue201ApplicationJsonPropertyDataPaymentMethod {
...
impl From<String> for CreateWalletTopUpResponseValue201ApplicationJsonPropertyDataPaymentMethod {
...
impl From<&str> for CreateWalletTopUpResponseValue201ApplicationJsonPropertyDataPaymentMethod {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for CreateWalletTopUpResponseValue201ApplicationJsonPropertyDataPaymentMethod {
...
impl<'de> Deserialize<'de>
    for CreateWalletTopUpResponseValue201ApplicationJsonPropertyDataPaymentMethod
{
