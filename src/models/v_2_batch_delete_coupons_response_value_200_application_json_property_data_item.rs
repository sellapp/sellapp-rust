...
#[serde(remote = "Self")]
pub struct V2BatchDeleteCouponsResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: V2BatchDeleteCouponsResponseValue200ApplicationJsonPropertyDataItemType,
    pub discount: String,
...
impl Serialize for V2BatchDeleteCouponsResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2BatchDeleteCouponsResponseValue200ApplicationJsonPropertyDataItem {
...
impl V2BatchDeleteCouponsResponseValue200ApplicationJsonPropertyDataItem {
