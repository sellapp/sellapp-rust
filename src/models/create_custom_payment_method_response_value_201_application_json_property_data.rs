...
#[serde(remote = "Self")]
pub struct CreateCustomPaymentMethodResponseValue201ApplicationJsonPropertyData {
    pub id: String,
    #[serde(rename = "type")]
    pub type_: CreateCustomPaymentMethodResponseValue201ApplicationJsonPropertyDataType,
    pub name: String,
    #[serde(
...
impl Serialize for CreateCustomPaymentMethodResponseValue201ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for CreateCustomPaymentMethodResponseValue201ApplicationJsonPropertyData
{
...
impl CreateCustomPaymentMethodResponseValue201ApplicationJsonPropertyData {
