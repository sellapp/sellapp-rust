...
#[serde(remote = "Self")]
pub struct GetSubscriptionResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub status: String,
    #[serde(
    ...
    pub customer: GetSubscriptionResponseValue200ApplicationJsonPropertyDataPropertyCustomer,
...
impl Serialize for GetSubscriptionResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for GetSubscriptionResponseValue200ApplicationJsonPropertyData {
...
impl GetSubscriptionResponseValue200ApplicationJsonPropertyData {
