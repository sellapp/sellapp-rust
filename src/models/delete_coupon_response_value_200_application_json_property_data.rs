...
#[serde(remote = "Self")]
pub struct DeleteCouponResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: DeleteCouponResponseValue200ApplicationJsonPropertyDataType,
    pub discount: String,
...
impl Serialize for DeleteCouponResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for DeleteCouponResponseValue200ApplicationJsonPropertyData {
...
impl DeleteCouponResponseValue200ApplicationJsonPropertyData {
