...
#[serde(remote = "Self")]
pub struct ListAffiliateReferralsResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
    ...
    pub status: ListAffiliateReferralsResponseValue200ApplicationJsonPropertyDataItemStatus,
    #[serde(skip_serializing_if = "Option::is_none", default)]
...
impl Serialize for ListAffiliateReferralsResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ListAffiliateReferralsResponseValue200ApplicationJsonPropertyDataItem
{
...
impl ListAffiliateReferralsResponseValue200ApplicationJsonPropertyDataItem {
