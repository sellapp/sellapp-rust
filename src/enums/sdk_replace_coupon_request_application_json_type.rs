...
#[non_exhaustive]
pub enum SdkReplaceCouponRequestApplicationJsonType {
    Percentage,
    Amount,
...
impl SdkReplaceCouponRequestApplicationJsonType {
...
impl fmt::Display for SdkReplaceCouponRequestApplicationJsonType {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkReplaceCouponRequestApplicationJsonType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkReplaceCouponRequestApplicationJsonType {
...
impl From<String> for SdkReplaceCouponRequestApplicationJsonType {
...
impl From<&str> for SdkReplaceCouponRequestApplicationJsonType {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkReplaceCouponRequestApplicationJsonType {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkReplaceCouponRequestApplicationJsonType {
