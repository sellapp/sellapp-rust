...
#[serde(remote = "Self")]
pub struct ExchangeOAuthTokenRequestApplicationXWwwFormUrlencodedOneOfValue1 {
...
impl Serialize for ExchangeOAuthTokenRequestApplicationXWwwFormUrlencodedOneOfValue1 {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ExchangeOAuthTokenRequestApplicationXWwwFormUrlencodedOneOfValue1 {
...
impl ExchangeOAuthTokenRequestApplicationXWwwFormUrlencodedOneOfValue1 {
