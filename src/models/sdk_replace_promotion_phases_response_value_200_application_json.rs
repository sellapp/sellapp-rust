...
#[serde(remote = "Self")]
pub struct SdkReplacePromotionPhasesResponseValue200ApplicationJson {
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub data: Option<Vec<ReplacePromotionPhasesResponseValue200ApplicationJsonPropertyDataItem>>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkReplacePromotionPhasesResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkReplacePromotionPhasesResponseValue200ApplicationJson {
...
impl SdkReplacePromotionPhasesResponseValue200ApplicationJson {
