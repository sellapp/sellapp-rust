...
#[non_exhaustive]
pub enum SearchOrderSLineItemsResponseValue200ApplicationJsonPropertyDataItemPropertyFulfillmentTypes
{
    Downloadable,
    Text,
    Dynamic,
...
impl SearchOrderSLineItemsResponseValue200ApplicationJsonPropertyDataItemPropertyFulfillmentTypes {
...
impl fmt::Display
    for SearchOrderSLineItemsResponseValue200ApplicationJsonPropertyDataItemPropertyFulfillmentTypes
{
