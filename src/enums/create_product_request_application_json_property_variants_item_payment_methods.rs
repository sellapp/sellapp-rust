...
#[non_exhaustive]
pub enum CreateProductRequestApplicationJsonPropertyVariantsItemPaymentMethods {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl CreateProductRequestApplicationJsonPropertyVariantsItemPaymentMethods {
...
impl fmt::Display for CreateProductRequestApplicationJsonPropertyVariantsItemPaymentMethods {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for CreateProductRequestApplicationJsonPropertyVariantsItemPaymentMethods {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for CreateProductRequestApplicationJsonPropertyVariantsItemPaymentMethods {
...
impl From<String> for CreateProductRequestApplicationJsonPropertyVariantsItemPaymentMethods {
...
impl From<&str> for CreateProductRequestApplicationJsonPropertyVariantsItemPaymentMethods {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for CreateProductRequestApplicationJsonPropertyVariantsItemPaymentMethods {
...
impl<'de> Deserialize<'de>
    for CreateProductRequestApplicationJsonPropertyVariantsItemPaymentMethods
{
