...
#[non_exhaustive]
pub enum UpdateOrderStatusResponseValue200ApplicationJsonPropertyDataPropertyTimelineItemStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl UpdateOrderStatusResponseValue200ApplicationJsonPropertyDataPropertyTimelineItemStatus {
...
impl fmt::Display
    for UpdateOrderStatusResponseValue200ApplicationJsonPropertyDataPropertyTimelineItemStatus
{
