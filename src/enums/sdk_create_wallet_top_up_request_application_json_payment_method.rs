...
#[non_exhaustive]
pub enum SdkCreateWalletTopUpRequestApplicationJsonPaymentMethod {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl SdkCreateWalletTopUpRequestApplicationJsonPaymentMethod {
...
impl fmt::Display for SdkCreateWalletTopUpRequestApplicationJsonPaymentMethod {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkCreateWalletTopUpRequestApplicationJsonPaymentMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkCreateWalletTopUpRequestApplicationJsonPaymentMethod {
...
impl From<String> for SdkCreateWalletTopUpRequestApplicationJsonPaymentMethod {
...
impl From<&str> for SdkCreateWalletTopUpRequestApplicationJsonPaymentMethod {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkCreateWalletTopUpRequestApplicationJsonPaymentMethod {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkCreateWalletTopUpRequestApplicationJsonPaymentMethod {
