...
#[serde(remote = "Self")]
pub struct SdkReplaceGeneralStoreSettingsRequestApplicationJson {
    pub name: String,
...
impl Serialize for SdkReplaceGeneralStoreSettingsRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkReplaceGeneralStoreSettingsRequestApplicationJson {
...
impl SdkReplaceGeneralStoreSettingsRequestApplicationJson {
