...
#[serde(remote = "Self")]
pub struct SdkUpdateCustomerPortalProfileResponseValue200ApplicationJson {
    pub data: UpdateCustomerPortalProfileResponseValue200ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkUpdateCustomerPortalProfileResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkUpdateCustomerPortalProfileResponseValue200ApplicationJson {
...
impl SdkUpdateCustomerPortalProfileResponseValue200ApplicationJson {
