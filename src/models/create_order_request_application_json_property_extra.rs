...
#[serde(remote = "Self")]
pub struct CreateOrderRequestApplicationJsonPropertyExtra {
    pub amount: i64,
    pub currency: String,
...
impl Serialize for CreateOrderRequestApplicationJsonPropertyExtra {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateOrderRequestApplicationJsonPropertyExtra {
...
impl CreateOrderRequestApplicationJsonPropertyExtra {
