...
#[serde(remote = "Self")]
pub struct SdkReplaceRewardRuleResponseValue200ApplicationJson {
    pub data: ReplaceRewardRuleResponseValue200ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkReplaceRewardRuleResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkReplaceRewardRuleResponseValue200ApplicationJson {
...
impl SdkReplaceRewardRuleResponseValue200ApplicationJson {
