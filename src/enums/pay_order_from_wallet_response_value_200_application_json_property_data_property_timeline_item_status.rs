...
#[non_exhaustive]
pub enum PayOrderFromWalletResponseValue200ApplicationJsonPropertyDataPropertyTimelineItemStatus {
    Pending,
    Reversed,
    Partial,
    Voided,
...
impl PayOrderFromWalletResponseValue200ApplicationJsonPropertyDataPropertyTimelineItemStatus {
...
impl fmt::Display
    for PayOrderFromWalletResponseValue200ApplicationJsonPropertyDataPropertyTimelineItemStatus
{
