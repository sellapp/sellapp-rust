...
#[serde(remote = "Self")]
pub struct CreateExportResponseValue201ApplicationJsonPropertyMeta {
    pub poll_after_seconds: i64,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for CreateExportResponseValue201ApplicationJsonPropertyMeta {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateExportResponseValue201ApplicationJsonPropertyMeta {
...
impl CreateExportResponseValue201ApplicationJsonPropertyMeta {
