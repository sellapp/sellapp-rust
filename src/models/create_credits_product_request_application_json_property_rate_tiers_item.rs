...
#[serde(remote = "Self")]
pub struct CreateCreditsProductRequestApplicationJsonPropertyRateTiersItem {
...
impl Serialize for CreateCreditsProductRequestApplicationJsonPropertyRateTiersItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateCreditsProductRequestApplicationJsonPropertyRateTiersItem {
...
impl CreateCreditsProductRequestApplicationJsonPropertyRateTiersItem {
