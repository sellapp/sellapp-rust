...
#[serde(remote = "Self")]
pub struct V2SearchTicketMessagesResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
    pub author: String,
...
impl Serialize for V2SearchTicketMessagesResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for V2SearchTicketMessagesResponseValue200ApplicationJsonPropertyDataItem
{
...
impl V2SearchTicketMessagesResponseValue200ApplicationJsonPropertyDataItem {
