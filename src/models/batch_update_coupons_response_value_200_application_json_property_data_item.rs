...
#[serde(remote = "Self")]
pub struct BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItemType,
    pub discount: String,
...
impl Serialize for BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItem {
...
impl BatchUpdateCouponsResponseValue200ApplicationJsonPropertyDataItem {
