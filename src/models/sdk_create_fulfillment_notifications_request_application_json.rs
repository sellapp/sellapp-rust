...
#[serde(remote = "Self")]
pub struct SdkCreateFulfillmentNotificationsRequestApplicationJson {
    #[serde(
...
impl Serialize for SdkCreateFulfillmentNotificationsRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkCreateFulfillmentNotificationsRequestApplicationJson {
...
impl SdkCreateFulfillmentNotificationsRequestApplicationJson {
