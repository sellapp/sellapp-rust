...
#[serde(remote = "Self")]
pub struct V2SearchSectionsRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for V2SearchSectionsRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for V2SearchSectionsRequestApplicationJsonPropertySearch {
...
impl V2SearchSectionsRequestApplicationJsonPropertySearch {
