...
#[serde(remote = "Self")]
pub struct CreateGroupResponseValue201ApplicationJsonPropertyDataPropertyImage {
...
impl Serialize for CreateGroupResponseValue201ApplicationJsonPropertyDataPropertyImage {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateGroupResponseValue201ApplicationJsonPropertyDataPropertyImage {
...
impl CreateGroupResponseValue201ApplicationJsonPropertyDataPropertyImage {
