...
#[serde(remote = "Self")]
pub struct AddHighlightMediaResponseValue201ApplicationJsonPropertyData {
    pub id: i64,
    pub sort_order: i64,
    #[serde(rename = "type")]
    pub type_: AddHighlightMediaResponseValue201ApplicationJsonPropertyDataType,
    pub url: String,
    pub filename: String,
    pub size: i64,
...
impl Serialize for AddHighlightMediaResponseValue201ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for AddHighlightMediaResponseValue201ApplicationJsonPropertyData {
...
impl AddHighlightMediaResponseValue201ApplicationJsonPropertyData {
