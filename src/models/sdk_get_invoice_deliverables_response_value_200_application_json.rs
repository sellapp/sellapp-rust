...
#[serde(remote = "Self")]
pub struct SdkGetInvoiceDeliverablesResponseValue200ApplicationJson {
    pub data: Vec<GetInvoiceDeliverablesResponseValue200ApplicationJsonPropertyDataItem>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkGetInvoiceDeliverablesResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkGetInvoiceDeliverablesResponseValue200ApplicationJson {
...
impl SdkGetInvoiceDeliverablesResponseValue200ApplicationJson {
