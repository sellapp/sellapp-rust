...
#[serde(remote = "Self")]
pub struct CreateStoreResponseValue201ApplicationJsonPropertyData {
    pub id: String,
    pub slug: String,
    pub name: String,
...
impl Serialize for CreateStoreResponseValue201ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for CreateStoreResponseValue201ApplicationJsonPropertyData {
...
impl CreateStoreResponseValue201ApplicationJsonPropertyData {
