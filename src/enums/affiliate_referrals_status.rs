...
#[non_exhaustive]
pub enum AffiliateReferralsStatus {
    Created,
    Accepted,
    InReview,
    Pending,
...
impl fmt::Display for AffiliateReferralsStatus {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for AffiliateReferralsStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for AffiliateReferralsStatus {
...
impl From<String> for AffiliateReferralsStatus {
...
impl From<&str> for AffiliateReferralsStatus {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for AffiliateReferralsStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for AffiliateReferralsStatus {
