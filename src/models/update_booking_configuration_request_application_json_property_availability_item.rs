...
#[serde(remote = "Self")]
pub struct UpdateBookingConfigurationRequestApplicationJsonPropertyAvailabilityItem {
    pub day: i64,
    pub enabled: bool,
    pub start: String,
    pub end: String,
...
impl Serialize for UpdateBookingConfigurationRequestApplicationJsonPropertyAvailabilityItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for UpdateBookingConfigurationRequestApplicationJsonPropertyAvailabilityItem
{
...
impl UpdateBookingConfigurationRequestApplicationJsonPropertyAvailabilityItem {
