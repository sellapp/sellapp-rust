...
#[serde(remote = "Self")]
pub struct SdkGetWebhookChannelResponseValue200ApplicationJson {
    pub data: GetWebhookChannelResponseValue200ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkGetWebhookChannelResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkGetWebhookChannelResponseValue200ApplicationJson {
...
impl SdkGetWebhookChannelResponseValue200ApplicationJson {
