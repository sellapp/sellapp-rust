...
#[serde(remote = "Self")]
pub struct SearchAppointmentsRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchAppointmentsRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchAppointmentsRequestApplicationJsonPropertySearch {
...
impl SearchAppointmentsRequestApplicationJsonPropertySearch {
