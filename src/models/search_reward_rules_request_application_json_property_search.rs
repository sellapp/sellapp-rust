...
#[serde(remote = "Self")]
pub struct SearchRewardRulesRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchRewardRulesRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchRewardRulesRequestApplicationJsonPropertySearch {
...
impl SearchRewardRulesRequestApplicationJsonPropertySearch {
