...
#[serde(remote = "Self")]
pub struct ReplaceCouponResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub code: String,
    #[serde(rename = "type")]
    pub type_: ReplaceCouponResponseValue200ApplicationJsonPropertyDataType,
    pub discount: String,
...
impl Serialize for ReplaceCouponResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ReplaceCouponResponseValue200ApplicationJsonPropertyData {
...
impl ReplaceCouponResponseValue200ApplicationJsonPropertyData {
