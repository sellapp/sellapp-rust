...
#[serde(remote = "Self")]
pub struct ReplaceCourseLessonRequestApplicationJsonPropertyAssignmentPropertyQuestionsItem {
    pub prompt: String,
    #[serde(
...
impl Serialize
    for ReplaceCourseLessonRequestApplicationJsonPropertyAssignmentPropertyQuestionsItem
{
...
impl ReplaceCourseLessonRequestApplicationJsonPropertyAssignmentPropertyQuestionsItem {
