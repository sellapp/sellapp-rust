...
#[serde(remote = "Self")]
pub struct SdkExchangeOAuthTokenResponseValue200ApplicationJson {
...
impl Serialize for SdkExchangeOAuthTokenResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkExchangeOAuthTokenResponseValue200ApplicationJson {
...
impl SdkExchangeOAuthTokenResponseValue200ApplicationJson {
