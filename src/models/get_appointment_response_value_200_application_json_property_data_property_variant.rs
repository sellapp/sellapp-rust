...
#[serde(remote = "Self")]
pub struct GetAppointmentResponseValue200ApplicationJsonPropertyDataPropertyVariant {
    #[serde(
...
impl Serialize for GetAppointmentResponseValue200ApplicationJsonPropertyDataPropertyVariant {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for GetAppointmentResponseValue200ApplicationJsonPropertyDataPropertyVariant
{
...
impl GetAppointmentResponseValue200ApplicationJsonPropertyDataPropertyVariant {
