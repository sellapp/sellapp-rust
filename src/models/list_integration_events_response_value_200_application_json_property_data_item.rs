...
#[serde(remote = "Self")]
pub struct ListIntegrationEventsResponseValue200ApplicationJsonPropertyDataItem {
    pub id: String,
    #[serde(rename = "type")]
    pub type_: String,
    pub version: i64,
    ...
    pub data: ListIntegrationEventsResponseValue200ApplicationJsonPropertyDataItemPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for ListIntegrationEventsResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ListIntegrationEventsResponseValue200ApplicationJsonPropertyDataItem
{
...
impl ListIntegrationEventsResponseValue200ApplicationJsonPropertyDataItem {
