...
#[non_exhaustive]
pub enum ReplaceProductVariantWithPutRequestApplicationJsonPropertyDeliverablePropertyDataParsingMode
{
    Comma,
    NewLine,
    Space,
...
impl ReplaceProductVariantWithPutRequestApplicationJsonPropertyDeliverablePropertyDataParsingMode {
...
impl fmt::Display
    for ReplaceProductVariantWithPutRequestApplicationJsonPropertyDeliverablePropertyDataParsingMode
{
