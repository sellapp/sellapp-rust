...
#[serde(remote = "Self")]
pub struct SdkV2ReplaceSectionGroupsRequestApplicationJson {
    pub resources: Vec<i64>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkV2ReplaceSectionGroupsRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkV2ReplaceSectionGroupsRequestApplicationJson {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        let mut value = serde_json::Value::deserialize(deserializer)?;
        crate::runtime_schema::model(
            &value,
            "SdkV2ReplaceSectionGroupsRequestApplicationJson",
            false,
        )
...
impl SdkV2ReplaceSectionGroupsRequestApplicationJson {
