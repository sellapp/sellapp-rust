...
#[serde(remote = "Self")]
pub struct SdkStartCommunityConnectionRequestApplicationJson {
    /// Discord-only connection mode.
    #[serde(skip_serializing_if = "Option::is_none", default)]
    pub mode: Option<SdkStartCommunityConnectionRequestApplicationJsonMode>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkStartCommunityConnectionRequestApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkStartCommunityConnectionRequestApplicationJson {
...
impl SdkStartCommunityConnectionRequestApplicationJson {
