...
#[serde(remote = "Self")]
pub struct V2ListTicketsResponseValue200ApplicationJsonPropertyDataItemPropertyReadStatus {
    pub customer: bool,
    pub store: bool,
...
impl Serialize for V2ListTicketsResponseValue200ApplicationJsonPropertyDataItemPropertyReadStatus {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for V2ListTicketsResponseValue200ApplicationJsonPropertyDataItemPropertyReadStatus
{
...
impl V2ListTicketsResponseValue200ApplicationJsonPropertyDataItemPropertyReadStatus {
