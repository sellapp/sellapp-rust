...
#[serde(remote = "Self")]
pub struct GetAffiliateResponseValue200ApplicationJsonPropertyDataPropertyBalances {
...
impl Serialize for GetAffiliateResponseValue200ApplicationJsonPropertyDataPropertyBalances {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for GetAffiliateResponseValue200ApplicationJsonPropertyDataPropertyBalances
{
...
impl GetAffiliateResponseValue200ApplicationJsonPropertyDataPropertyBalances {
