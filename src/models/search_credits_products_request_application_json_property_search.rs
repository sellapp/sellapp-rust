...
#[serde(remote = "Self")]
pub struct SearchCreditsProductsRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchCreditsProductsRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchCreditsProductsRequestApplicationJsonPropertySearch {
...
impl SearchCreditsProductsRequestApplicationJsonPropertySearch {
