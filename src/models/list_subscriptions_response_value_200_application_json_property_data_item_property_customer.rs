...
#[serde(remote = "Self")]
pub struct ListSubscriptionsResponseValue200ApplicationJsonPropertyDataItemPropertyCustomer {
    pub id: i64,
    pub email: String,
    pub external_id: Option<String>,
    pub name: Option<String>,
    pub locale: Option<String>,
    pub metadata: ListSubscriptionsResponseValue200ApplicationJsonPropertyDataItemPropertyCustomerPropertyMetadata,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize
    for ListSubscriptionsResponseValue200ApplicationJsonPropertyDataItemPropertyCustomer
{
...
impl ListSubscriptionsResponseValue200ApplicationJsonPropertyDataItemPropertyCustomer {
