...
#[non_exhaustive]
pub enum ReplaceBookingConfigurationResponseValue200ApplicationJsonPropertyDataVideoProvider {
    None,
    GoogleMeet,
    Zoom,
...
impl ReplaceBookingConfigurationResponseValue200ApplicationJsonPropertyDataVideoProvider {
...
impl fmt::Display
    for ReplaceBookingConfigurationResponseValue200ApplicationJsonPropertyDataVideoProvider
{
