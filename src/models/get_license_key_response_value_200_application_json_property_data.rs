...
#[serde(remote = "Self")]
pub struct GetLicenseKeyResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub key: String,
    pub limit: i64,
    pub active: i64,
...
impl Serialize for GetLicenseKeyResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for GetLicenseKeyResponseValue200ApplicationJsonPropertyData {
...
impl GetLicenseKeyResponseValue200ApplicationJsonPropertyData {
