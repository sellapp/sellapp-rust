...
#[serde(remote = "Self")]
pub struct PauseCustomerSubscriptionResponseValue200ApplicationJsonPropertyData {
    pub id: i64,
    pub status: String,
    #[serde(
...
impl Serialize for PauseCustomerSubscriptionResponseValue200ApplicationJsonPropertyData {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for PauseCustomerSubscriptionResponseValue200ApplicationJsonPropertyData
{
...
impl PauseCustomerSubscriptionResponseValue200ApplicationJsonPropertyData {
