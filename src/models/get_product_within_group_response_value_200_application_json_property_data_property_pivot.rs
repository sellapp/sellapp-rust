...
#[serde(remote = "Self")]
pub struct GetProductWithinGroupResponseValue200ApplicationJsonPropertyDataPropertyPivot {
    pub group_id: i64,
    pub listing_id: i64,
    pub order: i64,
...
impl Serialize for GetProductWithinGroupResponseValue200ApplicationJsonPropertyDataPropertyPivot {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for GetProductWithinGroupResponseValue200ApplicationJsonPropertyDataPropertyPivot
{
...
impl GetProductWithinGroupResponseValue200ApplicationJsonPropertyDataPropertyPivot {
