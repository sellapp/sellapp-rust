...
#[serde(remote = "Self")]
pub struct CreateOrderResponseValue201ApplicationJsonPropertyDataPropertyPayment {
...
impl Serialize for CreateOrderResponseValue201ApplicationJsonPropertyDataPropertyPayment {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for CreateOrderResponseValue201ApplicationJsonPropertyDataPropertyPayment
{
...
impl CreateOrderResponseValue201ApplicationJsonPropertyDataPropertyPayment {
