...
#[non_exhaustive]
pub enum GetPaymentMethodStatusResponseValue200ApplicationJsonPropertyDataConnectionType {
    OAuth,
    ApiKeys,
    Wallet,
    Custom,
...
impl GetPaymentMethodStatusResponseValue200ApplicationJsonPropertyDataConnectionType {
...
impl fmt::Display
    for GetPaymentMethodStatusResponseValue200ApplicationJsonPropertyDataConnectionType
{
...
impl FromStr for GetPaymentMethodStatusResponseValue200ApplicationJsonPropertyDataConnectionType {
...
impl Serialize for GetPaymentMethodStatusResponseValue200ApplicationJsonPropertyDataConnectionType {
