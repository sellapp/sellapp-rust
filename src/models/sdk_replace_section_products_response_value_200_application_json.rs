...
#[serde(remote = "Self")]
pub struct SdkReplaceSectionProductsResponseValue200ApplicationJson {
    pub data: ReplaceSectionProductsResponseValue200ApplicationJsonPropertyData,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for SdkReplaceSectionProductsResponseValue200ApplicationJson {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SdkReplaceSectionProductsResponseValue200ApplicationJson {
...
impl SdkReplaceSectionProductsResponseValue200ApplicationJson {
