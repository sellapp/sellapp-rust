...
#[serde(remote = "Self")]
pub struct GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertyPromotion {
    pub phase_id: i64,
...
impl Serialize for GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertyPromotion {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertyPromotion
{
...
impl GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertyPromotion {
