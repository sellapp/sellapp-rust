...
#[serde(remote = "Self")]
pub struct IssueReplacementForCompletedInvoiceResponseValue200ApplicationJsonPropertyWebhooksItem {
    pub url: String,
...
impl Serialize
    for IssueReplacementForCompletedInvoiceResponseValue200ApplicationJsonPropertyWebhooksItem
{
    ...
    for IssueReplacementForCompletedInvoiceResponseValue200ApplicationJsonPropertyWebhooksItem
{
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        ...
        crate::runtime_schema::model(&value, "IssueReplacementForCompletedInvoiceResponseValue200ApplicationJsonPropertyWebhooksItem", false).map_err(serde::de::Error::custom)?;
...
impl IssueReplacementForCompletedInvoiceResponseValue200ApplicationJsonPropertyWebhooksItem {
