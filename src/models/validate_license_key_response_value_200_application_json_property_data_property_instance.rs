...
#[serde(remote = "Self")]
pub struct ValidateLicenseKeyResponseValue200ApplicationJsonPropertyDataPropertyInstance {
    pub id: String,
...
impl Serialize for ValidateLicenseKeyResponseValue200ApplicationJsonPropertyDataPropertyInstance {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ValidateLicenseKeyResponseValue200ApplicationJsonPropertyDataPropertyInstance
{
...
impl ValidateLicenseKeyResponseValue200ApplicationJsonPropertyDataPropertyInstance {
