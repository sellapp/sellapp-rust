...
#[serde(remote = "Self")]
pub struct UpdateCustomerResponseValue200ApplicationJsonPropertyDataPropertyInsights {
...
impl Serialize for UpdateCustomerResponseValue200ApplicationJsonPropertyDataPropertyInsights {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for UpdateCustomerResponseValue200ApplicationJsonPropertyDataPropertyInsights
{
...
impl UpdateCustomerResponseValue200ApplicationJsonPropertyDataPropertyInsights {
