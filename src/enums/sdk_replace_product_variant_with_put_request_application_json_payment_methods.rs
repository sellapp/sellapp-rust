...
#[non_exhaustive]
pub enum SdkReplaceProductVariantWithPutRequestApplicationJsonPaymentMethods {
    Authnet,
    Btcpay,
    Cashapp,
    Coinbase,
...
impl SdkReplaceProductVariantWithPutRequestApplicationJsonPaymentMethods {
...
impl fmt::Display for SdkReplaceProductVariantWithPutRequestApplicationJsonPaymentMethods {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}

impl AsRef<str> for SdkReplaceProductVariantWithPutRequestApplicationJsonPaymentMethods {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl FromStr for SdkReplaceProductVariantWithPutRequestApplicationJsonPaymentMethods {
...
impl From<String> for SdkReplaceProductVariantWithPutRequestApplicationJsonPaymentMethods {
...
impl From<&str> for SdkReplaceProductVariantWithPutRequestApplicationJsonPaymentMethods {
    fn from(s: &str) -> Self {
        Self::from_str(s).unwrap_or_else(|_| Self::Unknown(s.to_string()))
    }
}

impl Serialize for SdkReplaceProductVariantWithPutRequestApplicationJsonPaymentMethods {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        serializer.serialize_str(self.as_str())
    }
}

impl<'de> Deserialize<'de> for SdkReplaceProductVariantWithPutRequestApplicationJsonPaymentMethods {
