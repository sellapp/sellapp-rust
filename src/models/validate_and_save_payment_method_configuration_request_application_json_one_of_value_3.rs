...
#[serde(remote = "Self")]
pub struct ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue3 {
    pub merchant_id: String,
    pub key_id: String,
    /// Write-only secret. SellApp never returns the stored value.
    pub key_secret: crate::SecretString,
    /// Write-only secret. SellApp never returns the stored value.
    pub webhook_secret: crate::SecretString,
    pub primary_currency: String,
    pub international_payments_enabled: bool,
    pub supported_currencies: Vec<String>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue3 {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue3
{
...
impl ValidateAndSavePaymentMethodConfigurationRequestApplicationJsonOneOfValue3 {
