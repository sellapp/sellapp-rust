...
#[serde(remote = "Self")]
pub struct SearchGroupsRequestApplicationJsonPropertySearch {
    #[serde(
...
impl Serialize for SearchGroupsRequestApplicationJsonPropertySearch {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for SearchGroupsRequestApplicationJsonPropertySearch {
...
impl SearchGroupsRequestApplicationJsonPropertySearch {
