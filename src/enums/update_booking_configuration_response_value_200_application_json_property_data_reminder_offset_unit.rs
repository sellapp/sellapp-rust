...
#[non_exhaustive]
pub enum UpdateBookingConfigurationResponseValue200ApplicationJsonPropertyDataReminderOffsetUnit {
    Minutes,
    Hours,
    Days,
    Weeks,
...
impl UpdateBookingConfigurationResponseValue200ApplicationJsonPropertyDataReminderOffsetUnit {
...
impl fmt::Display
    for UpdateBookingConfigurationResponseValue200ApplicationJsonPropertyDataReminderOffsetUnit
{
