...
#[serde(remote = "Self")]
pub struct GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertyDiscounts {
    pub coupon: Option<GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertyDiscountsPropertyCoupon>,
    ...
    pub modifiers: Vec<GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertyDiscountsPropertyModifiersItem>,
    /// Fields returned by a newer API version that are not yet known to this SDK.
    #[serde(default, flatten)]
    pub additional_properties: std::collections::HashMap<String, serde_json::Value>,
}
impl Serialize for GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertyDiscounts {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertyDiscounts
{
...
impl GetOrderLineItemResponseValue200ApplicationJsonPropertyDataPropertyDiscounts {
