...
#[serde(remote = "Self")]
pub struct GetRewardGrantResponseValue200ApplicationJsonPropertyDataPropertyCustomer {
...
impl Serialize for GetRewardGrantResponseValue200ApplicationJsonPropertyDataPropertyCustomer {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de>
    for GetRewardGrantResponseValue200ApplicationJsonPropertyDataPropertyCustomer
{
...
impl GetRewardGrantResponseValue200ApplicationJsonPropertyDataPropertyCustomer {
