...
#[serde(remote = "Self")]
pub struct ListPromotionPhasesResponseValue200ApplicationJsonPropertyDataItem {
    pub id: i64,
...
impl Serialize for ListPromotionPhasesResponseValue200ApplicationJsonPropertyDataItem {
    fn serialize<S: serde::Serializer>(&self, serializer: S) -> Result<S::Ok, S::Error> {
        Self::serialize(self, serializer)
    }
}
impl<'de> Deserialize<'de> for ListPromotionPhasesResponseValue200ApplicationJsonPropertyDataItem {
...
impl ListPromotionPhasesResponseValue200ApplicationJsonPropertyDataItem {
